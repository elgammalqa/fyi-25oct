	...
	@media only screen and (min-width: 991px) { 
		<?php if ($log==false) {  ?>
			#colorblack  li a{
                ...
                line-height: 32px;  padding-top: 16px; padding-right: 46px;
			}
		<?php }else {  ?>
			#colorblack  li a{
				color: white;
				font-size: 15px;  letter-spacing: 2px; font-weight: 700;
                line-height: 32px;  padding-top: 16px; padding-right: 35px;
			} 
	   <?php } ?>
				...
				<div class="container">					
					<div style="background-color: #55abcd;" id="menu-list">
						...
						<?php if(isMobile()){ ?>
							...
							<!-- 
							<li><a target="_blank" href="favorite_countries.php"  >favori kaynaklar</a></li>
							-->
							<?php if ($log==false) {  ?>
				...
				<div class="container">
				 ...
				 <div id="menu-lists">
					 ...
					 <?php if(isMobile()){ ?>
							...
							<li><a href="fyi_category.php?id=News&n=1">Haberler </a></li>
							<li><a href="fyi_category.php?id=Sports&n=1">Spor</a></li>
							<li><a href="fyi_category.php?id=Arts&n=1">Sanat</a></li>
							<li><a href="fyi_category.php?id=Technology&n=1">Teknoloji</a></li>
							<li><a href="fyi_category.php?id=Culture&n=1">Genel Kültür</a></li> 
							<li><a href="fyi_library.php?n=1">Kütüphane</a></li>  
						</ul>
					</div>
