...
'$id'");
                        ...
                        if(isset($_POST['handle_reply'])){
                            ...
                            switch ($publish_status){
                                case '1':
                                    $published = true;
                                    $mail_feedback_message = 'Cevap hakkı yayınlandı';
                                    break;
                                case '0':
                                    $mail_feedback_message = 'Cevap hakkı reddedildi';
                            }
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                            <td style='font-size: 19px; padding: 20px;  font-family: Helvetica; line-height: 150%; text-align: right;' >
                                               ...
                                               <br> <br>
                                               için FYIPress      <br><br>
                                               Cevap hakkınız gözden geçirildi
 <br>
                                               ".$mail_feedback_message." 
                                                <br>
                                                ".$feedback." <br> 
                                        ...
                                        <tr>  
                                            <td style='text-align: right; padding: 20px;' >
                                                ...
                                                Bütün hakları saklıdır FYIPress       
                                                </span> 
                                            </td>
                                        </tr>           
                                    </tbody> 
