...
<body> 
    <div class="content container">
        ...
        <div class="container stats"><br><h1   >Ülkeler listesi : </h1><hr></div>
        <div class="container-fluid">
         ...
         foreach($req as $country){ 
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
              <div class="card card-stats">
                ...
                <div class="card-footer">
                  <div class="stats">  
             <label class="containers">takip et 
             <?php   
              if($log==true){//logged 
          ...
          <?php }  //for  ?> 
             ...
             <input type="submit" class="green" name="Enregistrer" value="kayıt etmek" style="font-size: 26px; margin-right: 60px; " > 
            </form> 
          </div>   
        </div>   
            <?php  
