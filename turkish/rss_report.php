			...
			<div class="container">
				<div class="row"> 
                  ...
                  <div class="col-md-8">
		            ...
		            <div style="padding-left: 50px; padding-right: 50px;" >
		            	 <div class="form-group">
				            <label for="sel1">Raporun Türü :</label>
				              <select required="required" name="typee" class="form-control" id="sel1"> 
				                <option value="Cinsel içerik" >Cinsel içerik</option>
				                <option value="Şiddet içerik" >Şiddet içerik</option>
				                <option value="Kötü bir söz" >Kötü bir söz</option>
				                <option value="Nefret söylemi" >Nefret söylemi</option>
				                <option value="taciz" >taciz</option>
				              </select>
				          </div>
				          <div class="form-group">
				            <label for="pwd">diğer :</label>
				            <textarea name="other" rows="5" cols="20" class="form-control" placeholder="diğer ....." ></textarea> 
				         </div>
				         <div class="modal-footer">
				          <button type="submit" name="back" class="btn btn-primary" data-dismiss="modal">Geri</button>
				          <button type="submit" name="send" class="btn btn-success" data-dismiss="modal">göndermek</button>
				        </div>  
		            </div>
		            </form>
		            	<?php   
		          ...
		          <?php   }
                        ...
                        <?php  }else{ ?> 
                        	<script> 
                        	      swal("Dikkat!","Rapor eklenmedi! Bu yorumu zaten bildirdiniz","warning");
                            </script> 
		           		<?php }  
		           	}//id c
