						...
						<div class="box-body">
							...
							<form method="post" >
								...
								<div class="form-group text-right">
									...
									Doğrulama bağlantısını gönder</button>
								</div>
            	...
            	<td>
                    ...
                    <span style='font-size: 19px; padding: 20px;  font-family: Helvetica; line-height: 150%; text-align: left; color: #505050;' >   Copyright © FYI Press, Tüm hakları Saklıdır.  </span> 
				                ...
				                if ($mail->send()){
				                    ...
				                    echo '<script> swal("Şifre!", "Lütfen e-postanızı doğrulayın!","success");</script>';  
				                }else{
				                    echo '<script> swal("Parola! "," Birşeyler yanlıştı! Lütfen tekrar deneyin!","warning");</script>';  
				                } 
						            
				                }else{ // email confirmed
				                	 echo '<script> swal("E-posta! "," E-posta adresi zaten doğrulandı!","warning");</script>'; 
							 	}

							 	}else{//email not existe
							  echo '<script> swal("Abonelik! "," Abonelik yok!","warning");</script>'; 
							 	}
							 }
