					...
					<div class="box box-border">
						<div class="box-body">
							...
							<form method="post" > 
								...
								<div class="form-group">
									<label class="fw">Şifreyi Onayla</label>
									<input required="required" type="password" name="confirm_password" class="form-control">
								</div> 
								<div class="form-group text-right">
									<button name="change" class="btn btn-primary btn-block">Değişiklik</button>
								</div>
							</form> 
		                             ...
		                             if($tr==true){ 
							      	...
							      	$ps=password_hash($text, PASSWORD_DEFAULT); 
							           ...
							           if(isset($_COOKIE['fyiuser_pass'])){
							            ...
							            ?>
							          <script>swal("Şifre! "," Şifre başarıyla değiştirildi","success")</script> 
							         <?php }else{  ?>
					  <script>swal("Yanlış Şifre! "," Şifreler aynı değil","warning")</script>
							         <?php 
							         }//confirm  
							     }else{// 5 numbers and 1 letter 
							     	  $msgg='şifre (bir karakter veya bir harf) ve bir sayı dahil olmak üzere en az altı karakter olmalıdır';
							     	?>
							      <script>
							  ...
							  <?php   }
							          ...
							          ?>
							           <script>swal("Şifre eşleşmiyor! "," Mevcut şifre yanlış","warning")</script>
							         <?php
							          }//current
