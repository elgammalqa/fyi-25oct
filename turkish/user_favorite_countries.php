...
<div class="content container">
    ...
    <div class="row source_top_row">
        ...
        <div class="col-xs-6 col-sm-4 col-md-2">
            <a href="favorite_countries.php" class="btn btn-md btn-primary <?=(!stristr($page,'user_')) ? 'selected' : '';?>">Tüm ülkeler</a>
        </div>
        <div class="col-xs-6 col-sm-4 col-md-2">
            <a href="user_favorite_countries.php" class="btn btn-md btn-primary <?=(stristr($page,'user_')) ? 'selected' : '';?>">Kaynaklarım</a>
        </div>
    </div>

    <div class="container stats" style="display: none"><br><h1 style="text-align: right;"  >   Ülkeler listesi   </h1><hr></div>
...
if ($log) {
    ...
    foreach ($all_user_sources as $source) {
        $topic = 'tu-' . str_replace(' ', '__', $source['country']) . '-' . str_replace(' ', '__', $source['source']);
    ...
    foreach ($selected_sources as $src) {
        ...
        $topic = 'tu-' . str_replace(' ', '__', $country) . '-' . str_replace(' ', '__', $source);
        $fcm = new WebFCMToTopic();
