	...
	@media only screen and (min-width: 991px) { 
		<?php if ($log==false) {  ?>
			#colorblack  li a{
                ...
                line-height: 32px;  padding-top: 16px; padding-right: 20px;
			}
		<?php }else {  ?>
			#colorblack  li a{
				color: white;
				font-size: 15px;  letter-spacing: 2px; font-weight: 700;
                line-height: 32px;  padding-top: 16px; padding-right: 10px;
			} 
	   <?php } ?>
					...
					<div style="background-color: #55abcd;" id="menu-list">
						...
						<?php if(isMobile()){ ?>
							<li style="background-color: red; " class="backk" ><a 
								style="  font-size: 30px; color:#fff; border-bottom: none !important; ">Geri <i style="text-align: left; font-size: 30px;" class="ion-ios-arrow-forward"></i></a></li> 
							 <?php }else{ ?> 
							...
							<li><a href="favorite_countries.php"  >favori kaynaklar</a></li>
							<?php if ($log==false) {  ?>
							<li><a href="login.php"  >Giriş Kayıt</a></li>
							 ...
							 <ul id="colorblack2" class="dropdown-menu">  
									<li>
										<a href="resetpass.php">
										    <i  class="icon ion-key">  </i>Şifre değiştir
									    </a>
									</li> 
									<li class="divider"></li>
									<li><a href="logout.php">
										<i class="icon ion-log-out"></i> Çıkış Yap</a></li>
								</ul>
						    </li> 
						<?php } 
						 if(!isMobile()){ ?>
							<li  class="dropdown magz-dropdown">
										<a style="  padding-left:50px;">Diller <i class="ion-ios-arrow-right"></i></a>
										<ul id="colorblack2" class="dropdown-menu">
											...
											<li><a class="pl"  href="index.php" >Türkçe</a></li>
				 ...
				 <div id="menu-lists">
					 ...
					 <?php if(isMobile()){ ?>
							<li style="background-color: red; " class="backk" >
								<a style="  font-size: 30px; color:#fff; border-bottom: none !important; ">Geri <i style="text-align: left; font-size: 30px;" class="ion-ios-arrow-forward"></i></a></li>
							 <?php } ?> 
							<li><a href="index.php">Ana Sayfa </a></li>
                            <li><a href="breaking_news.php?n=1">Flaş Haber</a></li>
                            <?php
                            ...
                            ?>
							<li><a href="category.php?id=News&n=1">Haberler </a></li>
							<li><a href="category.php?id=Sports&n=1">Spor</a></li>
                            <li><a href="category.php?id=Economy&n=1">ekonomi</a></li>
                            <li><a href="category.php?id=Health&n=1">Sağlık</a></li>
							<li><a href="category.php?id=Arts&n=1">Sanat</a></li>
							<li><a href="category.php?id=Technology&n=1">Teknoloji</a></li>
							<li><a href="category.php?id=Culture&n=1">Kültür</a></li>
							<li><a href="library.php?n=1">Kütüphane</a></li>
                            <li class="dropdown"><a  href="#">Ülkeler</a>
