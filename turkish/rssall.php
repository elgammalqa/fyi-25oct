	...
	if(isset($_GET['id'])&&!empty($_GET['id'])){
							...
							<div class="row">
								<div class="col-md-12">        
									<ol class="breadcrumb">
										...
										<li class="active">RSS  Hızlandırıcı</li>
									</ol>
									<h1 class="page-title">Kategori: RSS ÜCRETLERİ</h1>
									<p class="page-subtitle">Diğer Dergilerden gelen tüm rss <i> gösteriliyor</i></p>
								</div>
							</div>
							<div class="line"></div>
							<div class="row">
		...
		<div class="col-md-4 sidebar" id="sidebar"> 
			<?php  if(news_publishedModel::nbrhotnews()>0){  ?>
				<aside>
					<br>
					<h1  id="ptop" class="aside-title">Son Haberler</h1>
