						...
						<div class="box-body">
							...
							<form method="post" >
								...
								<div class="form-group text-right">
									<button class="btn btn-primary btn-block" name="reset" >Şifreyi yenile</button>
								</div>
								<div class="form-group text-center">
									<span class="text-muted">Girişe geri dön?</span> <a href="login.php">Oturum aç</a>
								</div> 
							</form>
							<?php 
        ...
        <tbody>
          <tr>
            ...
            <tr>
              ...
              Merhaba  $name , <br> <br> Hoşgeldiniz FYI Press .  <br><br>
              Şifrenizi sıfırlamak için ,<br>
              ...
              <td>
                    ...
                    <span style='font-size: 19px; padding: 20px;  font-family: Helvetica; line-height: 150%; text-align: left; color: #505050;' >Copyright © FYI Press, Tüm hakları Saklıdır.  </span> 
				                ...
				                if ($mail->send()) {
				                    ...
				                    echo '<script> swal("Parola! "," Lütfen E-posta Gelen Kutunuzu Kontrol Edin!","success");</script>'; 
				               } else{
				                    echo '<script> swal("Parola !","Ters şeyler oldu! Lütfen tekrar deneyin!","warning");</script>'; 
				               }
							 	}else{
							 		 echo '<script> swal("abone !","Eğer üye değilseniz!","warning");</script>'; 
							 	}
							 }
