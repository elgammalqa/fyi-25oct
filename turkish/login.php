						...
						<div class="box-body">
							...
							<form method="post" >
								<div class="form-group">
									<label>E-Mail</label>
									<input placeholder="E-postanızı giriniz" required="required" type="email" name="username" class="form-control">
								</div>
								<div class="form-group"> 
									<label class="fw">Gizli Şifreniz
									</label>
									<input  placeholder="Şifrenizi girin" required="required" type="password" name="password" class="form-control">
									<a href="forgot.php" class="pull-right">Parolanızı mı unuttunuz?</a>
									<!-- href="forgot.php" -->
								</div>
								<br>
								<div class="form-group text-right">
									<button name="login" class="btn btn-primary btn-block">Oturum aç</button>
								</div>
								<div class="form-group text-center">
									<span class="text-muted">Size özel hesabınız yok mu?</span> <a href="register.php">Hesap Oluştur</a> <br>
									<span class="text-muted">Doğrulama bağlantınızı almadınız: <br>
									</span> <a href="link_verification.php">Yeniden gönder</a>
								</div>  
							</form>  
