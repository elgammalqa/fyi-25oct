				  ...
				  <?php if(news_publishedModel::nbrhotnews()>0){  ?> 
						<aside> 
							...
							<div class="aside-body"> 
								<?php    
								$xnews=new news_publishedModel();   
									$query=$xnews->hotnews(4);
							...
							<article class="article-fw" style="padding-bottom: 40px;" >
								<div class="inner">
									...
									<div class="details">
										...
										<div class="detail"   > 
										 	  <a class=" xtype">  
									          <?php echo utilisateursModel::source($typesection); ?> </a> 
										  	<span class="xdate" >
					...
					?> 
					 ...
					 <header> 
						...
						<article class="article main-article"> 
							<div class="main" style="padding-top: 0px !important;  margin-top: 20px; " > 
						...
						<div class="xtypedate" >
							...
							<span class="xdate" >
									 نشر  <?php real_news_time($news->getpubDate()); ?>
							</span>  
						</div>
  						<div class="xdetail2"> 
					...
					<?php if(news_publishedModel::nbrnewsStartCountVideos2()>0){ ?> 
						<div class="line"><div>فيديوهات </div></div> 
						<div class="row">  
							 <?php  	// news videos    
					 	$news=new news_publishedModel();   
					    ...
					    foreach ($qr as $comment) {   ?>  
						    ...
						    <?php if ($log==true){?>
							    ...
							    <a href="<?php echo 'detaill.php?id='.$id_art_actuel.'&r='.$comment['id']; ?>">
								   <button type="button" class="btn btn-primary xreply" data-dismiss="modal"> رد  
								    </button>
								    </a>
					    ...
					    <?php	$qrss=repliesModel::repliesStartNbres(0,10,$id_art_actuel,$comment['id']);
					        foreach ($qrss as $reply) {    ?> 
							   ...
							   <?php if ($log==true){?>
								    <div style="border: none;" class="modal-footer">
								    	<a href="<?php echo 'detaill.php?id='.$id_art_actuel.'&r='.$comment['id']; ?>">
								        	<button type="button" class="btn btn-primary xreply" 
								        		data-dismiss="modal"> رد  
								        	</button>
								    	</a>
