						...
						<div class="box-body">
							...
							<form method="post" >
								...
								<div style="font-family: 'Droid Arabic Kufi', serif; letter-spacing: 0px; text-align: center;" class="form-group "  >
									<span  class="text-muted ">ليس لديك حساب ؟</span><a href="register.php">أنشئ حساب</a><br>
									<span class="text-muted">ألم تستلم الرابط<br>
									</span> <a href="link_verification.php">الإرسال مرة أخري</a>
								</div>  
							</form>  
                    ...
                    if (utilisateursModel::acount_is_confirmed($_POST['username'])) {  
	                      	  ...
	                      	  $user->active_status($logg);
                                  ...
                                  if(isset($_SESSION['reply_url'])){
								   ...
								   echo '<script> swal(" تم الرفض!","رجاءاً تحقق من بريدك الالكتروني ، لقد قمنا بارسال رسالة تاكيدية أو أضغط للارسال  
								   ","warning");</script>';
	                      	 }  

                    }else{ ?>
                      <script> swal("Access denied!","خطأ في البريد الالكتروني أو كلمة المرور، حاول مرة أخري","warning");</script>
             <?php  }
            }else{ ?>
                  <script> swal("خطأ في البريد الالكتروني أو كلمة المرور، حاول مرة أخري","warning");</script>
      <?php }  
    } ?>
						</div>
					</div>
