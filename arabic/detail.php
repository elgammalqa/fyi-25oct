        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                if ($news->findnews($_GET['id']) != null) {
                    ...
                    <article class="article main-article">
                        <div class="main" style="padding-top: 0px !important;  margin-top: 20px; ">
                            ...
                            <?php
                            $replyData = $news->get_news_reply_link($news->getReplyId());
                            $videoData = $news->get_right_of_reply_video($news->getReplyId());
                            if ($replyData['reply_to_link'] != '') {
                                ?>
                                <div class="xtype">
                                    <a href="<?php echo $replyData['reply_to_link']; ?>" target="_blank">رداً على ما جاء بهذا الرابط</a>
                                </div>
                                <?php
                            }
                            ?>
                ...
                <div class="comments">
                    ...
                    <?php if ($log == true){ ?>
                    <form style="padding-bottom: 50px;" enctype="multipart/form-data"
                        ...
                        <div class="form-group col-md-4 col-xs-12 " style="float: left;">
                            <input value="  نشر " name="send" type="submit" class="btn btn-primary form-control "
                                   style="font-size: 27px; font-weight: bold; padding-top:0px !important; margin-top: 0px !important">
                        </div>
                    </form>
                </div>
            <?php
