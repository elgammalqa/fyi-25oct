			...
			<div class="container">
			 ...
			 <div class="col-md-4 sidebar" id="sidebar" style="margin-top: 15px;"> 
					  <?php if(news_publishedModel::nbrhotnews()>0){  ?> 
						<aside> 
							<br>
							<h5 class=" float_right" style="font-family: 'Droid Arabic Kufi', serif; letter-spacing: 0px; margin-bottom: 0px;"  >الاخبار الحالية</h5> 
                  ...
                  <div class="col-md-8">
		            ...
		            <div style="padding-left: 50px; padding-right: 50px;" >
		            	 <div class="form-group">
				            <label for="sel1" class="myfont" >  نوع الإساءة   </label>
				              <select required="required" name="typee" class="form-control" id="sel1" 
				              class="myfont2" style="font-size: 20px;"> 
				                <option value="A bad words" > كلمات سيئة  </option>
				                <option value="Sexual content" >  محتوى جنسي  </option>
				                <option value="Violent content" > محتوى عنيف   </option>
				                <option value="Hate speech" > خطاب كراهية  </option>
				                <option value="Abuse" > إساءة  </option>
				              </select>
				          </div>
				          <div class="form-group">
				            <label for="pwd" class="myfont"> شيء آخر   </label>
