                                    ...
                                    <div class="x_content">
                                        ...
                                        <form enctype="multipart/form-data" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" id="phone" name="Phone" required="required" value="<?php echo $user->getLast_name(); ?>" class="form-control col-md-7
                                    col-xs-12">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" name="Phone" value="<?php echo $user->getPhone(); ?>" id="phone" required="required" class="form-control col-md-7
                                    col-xs-12">
                                                </div>
                                            </div>
