...
include '../models/user.model.php'; 
  if(userModel::islogged("Admin")==true){ 
    if(userModel::isLoged_but_un_lock()){
      ...
      if (count($_COOKIE)>0)  setcookie('fyiplien','a_by_date_and_country.php',time()+2592000,"/");
       else   $_SESSION['auth']['lien']="a_by_date_and_country.php"; 
...
<script type="text/javascript">
  ...
  <body class="nav-md">
   ...
   if (userModel::traffic_country_B_two_dates($cc,$_POST['date1'],$_POST['date2'])!=null) { ?> 
            <div style="margin-top: 2%" class="col-md-6 col-sm-12 col-xs-12 col-md-offset-2">
                 <table class="table table-striped jambo_table bulk_action">
                      ...
                      <tbody>  
                        <tr class="headings"> 
                          <th  class="column-title"> <?php echo $cc; ?> </th> 
                          <th class="column-title" > <?php echo $d1; ?> </th> 
                          <th class="column-title" > <?php echo $d2; ?> </th> 
                           <th  class="column-title"> 
                            <span style="color: red; font-size: 15px; "  >
                              <?php echo userModel::traffic_country_B_two_dates($cc,$_POST['date1'],$_POST['date2']); ?>
                            </span>   
                          </th>   
                        </tr> 
                      </tbody> 
             ...
             <?php } else {
                           echo '<script>swal("No Visitor","There is No Visitors From '.$cc.' Between '.$d1.' and '.$d2.'","warning")</script>';
                  } 
               } else {
