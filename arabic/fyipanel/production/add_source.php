                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-7 col-sm-6 col-xs-12">
                              ...
                              <br>
                              في حالة إضافة نفس المصدر داخل أكثر من فئة يتم إضافة حساب تويتر في فئة واحدة فقط
                          </div>
                      </div>
                      ...
                      Type : &nbsp;&nbsp; </label>
                      <div class="col-md-7 col-sm-6 col-xs-12">  
                       <input  required="required" name="type" for="middle-name"
                      ...
                      Country : &nbsp;&nbsp; </label>
                      <div class="col-md-7 col-sm-6 col-xs-12">  
                       <input  required="required" name="country" for="middle-name"
