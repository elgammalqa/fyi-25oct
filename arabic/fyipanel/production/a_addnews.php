...
include '../models/news.model.php'; 
  if(userModel::islogged("Admin")==true){ 
    if(userModel::isLoged_but_un_lock()){
     ...
     if (count($_COOKIE)>0)  setcookie('fyiplien','a_addnews.php',time()+2592000,"/");
       else   $_SESSION['auth']['lien']="a_addnews.php";   
              ...
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <ul class="nav navbar-right panel_toolbox">
                      <li><a style="color: green; font-weight: bold;" target="_blank" href="a_thumbnail_content.php">
                      Add preview image to video</a></li> 
                       <li><a></a></li> 
                       <li><a style="color: red; font-weight: bold;" target="_blank" href="linkadmin.php">
                      Add media  </a></li>
                 ...
                 <form method="POST" id="demo-form2" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo $_SERVER['PHP_SELF']; ?>" > 
                    <div class="form-group"> 
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input required="required" type="text" name="title" id="first-name"   class="form-control col-md-7 col-xs-12" style="direction: rtl;">
                      </div>
                    </div>
                    <div class="form-group"> 
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input  type="text" id="last-name" name="description"  class="form-control col-md-7 col-xs-12" style="direction: rtl;">
                      </div>
                    </div> 
                    <div class="form-group"> 
                      <label  style="text-align: left" class="control-label col-md-2 col-sm-3 col-xs-12 col-md-offset-1 col-sm-offset-1" >
                    ...
                    <div class="form-group"> 
                      ...
                      <div class="col-lg-12 nopadding">  
                          <textarea  class="tinymce" name="contentx" style="direction: rtl;" ></textarea>  
                      </div>
                      </div>
                    </div>
