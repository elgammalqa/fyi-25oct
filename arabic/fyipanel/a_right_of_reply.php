...
'$id'");
                        ...
                        if($_SESSION['saved'] == 0){
                            ?>
                            <script>
                                swal(" انتباه ", 'حطث خطأ! برجاء إعادة المحاولة' ,'error')
                            </script>
                        <?php
                        }
                        if($_SESSION['saved'] == 1){
                        ?>
                            <script>
                                swal(" تم", 'تمت العملية بنجاح' ,'success')
                            </script>
                            <?php
                        }
                            $_SESSION['saved'] = 3;
                        ...
                        if(isset($_POST['handle_reply'])){
                            ...
                            switch ($publish_status){
                                case '1':
                                    $mail_feedback_message = 'تمت الموافقة على نشر حق الرد';
                                    break;
                                case '0':
                                    $mail_feedback_message = 'لم تتم الموافقة على نشر حق الرد';
                            }
                            ...
                            if($q->execute()){
                                ...
                                $mail->Subject="موقع إف واي آي برس مراجعة حق الرد";
                                $name = $row['name'];
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                            <td style='font-size: 19px; padding: 20px;  font-family: Helvetica; line-height: 150%; text-align: right;' >
                                               ...
                                               تم مراجعة حق الرد الذي قمت بإضافته <br>
                                               ".$mail_feedback_message." 
                                                <br>
                                                ".$feedback." <br> 
                       ...
                       ";
                        ...
                        <table class="table table-bordered">
                            ...
                            if($row['user_image'] !== ''){
                                ...
                                <tr>
                                    <td>صورة المستخدم</td>
                                    <td><img src="<?=$domain?>arabic/images/rss_comments/<?=$row['user_image']?>" style="max-width: 250px;" alt=""></td>
                                </tr>
                                <?php
                            }
                            ?>
                            ...
                            if($row['uploaded_image'] !== ''){
                                ...
                                <tr>
                                    <td>صورة الرد</td>
                                    <td><img src="<?=$domain?>arabic/images/rss_comments/<?=$row['uploaded_image']?>" style="max-width: 450px;" alt=""></td>
                                </tr>
                                <?php
                            }
                            ?>
