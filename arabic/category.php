								...
								<div class="inner">
									...
									<div class="details">
										...
										<div class="detail float_right " style="padding-top: 10px;" >
                                            ...
                                            <div style="margin-right: 25px; float: left; font-size: 17px; direction: rtl;"><a class="right_of_reply_news_link" target="_blank"  alt=""></a></div>
										</div>
									</div>
								</div>
							</article>
                                              ...
                                              <div class="details mar_right">
                                                        ...
                                                        <div class="detail" style="float: right;">
                                                            ...
                                                            <div class="time right_of_reply">
                                                                <span class="float_rightd">
                                                                    <a class="right_of_reply_news_link" href="news_reply.php?news=<?=$news['id']?>&r=<?=$news['rank']?>">حق
                                                                        الرد<img src="../images/microphone.png" alt=""></a>
                                                                </span>
                                                            </div>
				            ...
				            <div class="inner">
				              ...
				              <div class="details mar_right"> 
				    					...
				    					<div class="detail" style="float: right;">
                                            ...
                                            <div class="time right_of_reply">
                                                                <span class="float_rightd">
                                                                    <a class="right_of_reply_news_link" href="news_reply.php?news=<?=$news['id']?>&r=<?=$news['rank']?>">حق الرد<img src="../images/microphone.png" alt=""></a>
                                                                </span>
                                            </div>
				    					</div> 
				    				</div>  
