...
if (isset($_GET['news']) && !empty($_GET['news']) && isset($_GET['r']) && ($_GET['r'] == 1 || $_GET['r'] == 2)) {
    ...
    <br>بشرط مراعاة الآداب العامة <br>وسياسة الموقع . يوفر موقع إف واي<br> آي برس لك حق الرد على أي خبر أو<br> مقال  يتم نشره لديه .. ولكن ما يتم<br> نشره هو على مسؤولية من قام<br> بالنشر دون أي مسؤولية على إف<br> واي آي برس  </span>
                                            ...
                                            <div class="col-xs-12" id="date" style="margin-bottom: 15px;">
                                                <label for="date">رداً على ما تم نشره بتاريخ</label>
                                            ...
                                            <div class="col-xs-12" id="news_title" style="margin-bottom: 15px;">
                                                <label for="news_title">بعنوان</label>
                                            ...
                                            if ((int)$_GET['r'] == 2) {
                                                ...
                                                <div class="col-xs-12" id="source" style="margin-bottom: 15px;">
                                                    <label for="source">إسم جهة النشر</label>
                                            ...
                                            <div class="col-xs-12" id="link" style="margin-bottom: 15px;">
                                                <label for="link"><span class="required"></span>قم بلصق رابط ما تقوم بالرد عليه</label>
                                                <input type="text" name="link" value="" class="form-control">
                                            </div>

                                            <div class="col-xs-12" id="phone" style="margin-bottom: 15px;">
                                                <label for="phone">هاتف القائم بالرد</label>
                                                <input type="text" name="phone" value="" class="form-control">
                                            </div>

                                            <div class="col-xs-12" id="email" style="margin-bottom: 15px;">
                                                <label for="emai">البريد الإلكتروني</label>
                                                <input type="text" name="emai" value="<?= $d->getemail() ?>" required class="form-control" disabled>
                                            </div>

                                            <div class="col-xs-12" style="margin-bottom: 15px;">
                                                <label for="message_to_admin">رسالة من قائم على الرد إلى إف واي آي بريس (لا يتم نشرها)</label>
                                    ...
                                    <div class="form-group col-xs-12 col-md-8" style="text-align: right; direction: rtl; margin-bottom: 0;">
                                        ...
                                        <div class="row checkboxes">
                                            ...
                                            <div class="col-xs-12 col-sm-3">
                                                <a href="replies.php?id=<?= $row['type'] ?>&n=1" class="display_replies_link">استعراض الردود</a>
                                            </div>
                                        ...
                                        <div class="row formdata" style="position: relative;">
                                            ...
                                            <div class="col-xs-11 col-md-10 col-md-push-2" style="margin-bottom: 12px;">
                                                <label for="username"><span class="required"></span>عنوان الرد</label>
                                                <input type="text" name="title" value="" id="title" class="form-control" required>
                                            </div>
                                            <div class="col-xs-11 col-md-10 col-md-push-2">

                                                <label for="username"><span class="required"></span>إسم القائم بالرد</label>
                                                <input type="text" name="username" value="<?= $d->getname() ?>" id="username" class="form-control" disabled required>
                                            </div>

                                            <input value="نشر" name="send_right_of_reply" type="submit" class="btn btn-primary form-control">
                                            ...
                                            <div class="col-xs-6 col-md-6">
                                                <div class="box file_upload">
                                                    ...
                                                    <label for="file-3"><span>الصورة الرئيسية للرد (اختياري) <i class="fa fa-upload"></i></span></label>
                                                </div>
                                            ...
                                            <div class="col-xs-6 col-md-6">
                                                <div class="box file_upload">
                                                    <input type="file" name="file-4" id="file-4" class="inputfile inputfile-4" data-multiple-caption="{count} files selected"
                                                           accept="image/png, image/jpeg"/>
                                                    <label for="file-4"><span>صورة القائم بالرد (اختياري) <i class="fa fa-upload"></i></span></label>
                                                </div>
                                            ...
                                            <div class="col-xs-12">
                                                <div class="box boxhint">
                                                    <label><span>في أي مرحلة يمكنك إضافة صور أو فيديو بين السطور</span></label>
                                                </div>
                                            </div>

                                            <div class="col-xs-12" style="margin-top: 25px;">
                                                <label for="myTextField2">الرد</label>
        ...
        <script>tinymce.init({
                ...
                images_upload_base_path: 'https://www.fyipress.net/arabic/uploaded_images',
                ...
                image_advtab: true ,
                external_filemanager_path:"/fyi/arabic/filemanager/",
