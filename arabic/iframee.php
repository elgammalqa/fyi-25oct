							...
							<?php if ($log){ ?> 
								<form style="padding-bottom: 50px;" id="fff" enctype="multipart/form-data" method="post" class="row"> 
									<div class="form-group col-md-12" style="text-align: right;">
										...
										<textarea style="text-align: right; font-size: 26px;"  maxlength="500" required="required" id="myTextField"  class="form-control" name="message"   placeholder=" اكتب تعليق  "></textarea>
									</div>  <div class="image-upload form-group col-md-8 col-xs-12 " style="float: right;" >  
