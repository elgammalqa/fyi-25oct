                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="card card-stats">
                                ...
                                <a href="favorite_types.php?country=<?php echo $pays; ?>&source=<?php echo $source; ?>" class="fav_source_link">
                                    ...
                                    <span class="followers_count">متابع  <?= number_format_unchanged_precision($id_count) ?> </span>
                                </a>
                                ...
                                <div class="col-xs-2 follow_unfollow_source" style="position: relative;">
                                    ...
                                    if ($log == true) { //logged
                                        ...
                                        if (isset($_COOKIE['arabic_sources'])) { //there is a cookie
...
if ($GLOBALS['nb_sources_not_checked'] >= 5) {//ok we can continue
    ...
    if ($log == false) {
        ...
        if (isset($_COOKIE['arabic_sources'])) {
            ...
            setcookie('arabic_sources', json_encode($data), time() + 31556926, '/');

        } else {

            setcookie('arabic_sources', json_encode($notchecked), time() + 31556926, '/');
...
<?php
    ...
    echo "<script> alert('يجب أن تتابع على الاقل خمسة مصادر'); </script>";
