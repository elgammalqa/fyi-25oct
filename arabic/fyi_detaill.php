							...
							<article class="article-fw " >
								<div class="inner"> 
									...
									<div class="details" style="background-color: white">
										...
										<div class="detail  "   >
											<a class="xtype">  
									          <?php echo utilisateursModel::type($typesectionv); ?> </a>
										  	<span class="xdate" >
												<?php real_news_time($news['pubDate']); ?>  
										   </span>
										   <?php   if($log){
				    ...
				    <?php $qr=commentsModel::commentsStartNbres(0,10,$id_art_actuel);
					    foreach ($qr as $comment) {   ?>  
						    ...
						    <div style="margin-left: 10%;" id="example1">
							    ...
							    <p style="font-family: 'Droid Arabic Kufi', serif; letter-spacing: 0px; font-size: 15px;"><?php echo $comment['response']; ?></p> 
							    <div class="abc" >
