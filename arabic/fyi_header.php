				...
				<?php if(!isMobile()){ ?>
 				...
 				<ul class="nav-list plm"> 
 				 <?php if(isMobile()){ ?>
							...
							<a style="font-family: 'Droid Arabic Kufi', serif; letter-spacing: 0px;" href="fyi.php">الرئيسية</a> 
							</li> 
							<li class="header_float_right" ><a style="font-family: 'Droid Arabic Kufi', serif; letter-spacing: 0px;" href="fyi_category.php?id=News&n=1">الأخبار</a></li> 
							<li class="header_float_right" ><a style="font-family: 'Droid Arabic Kufi', serif; letter-spacing: 0px;" href="fyi_category.php?id=Sports&n=1">الرياضة</a></li>
							<li class="header_float_right" ><a style="font-family: 'Droid Arabic Kufi', serif; letter-spacing: 0px;" href="fyi_category.php?id=Arts&n=1">الفن</a></li>
							<li class="header_float_right" ><a style="font-family: 'Droid Arabic Kufi', serif; letter-spacing: 0px;" href="fyi_category.php?id=Technology&n=1">التكنولوجيا</a></li>
							<li class="header_float_right" ><a style="font-family: 'Droid Arabic Kufi', serif; letter-spacing: 0px;" href="fyi_category.php?id=Culture&n=1">الثقافة العامة</a></li>
							<li class="header_float_right" ><a style="font-family: 'Droid Arabic Kufi', serif; letter-spacing: 0px;" href="fyi_library.php?n=1">المكتبة</a></li>
