		...
		function getrssnews($n,$l){  
			if(v5newspublished::nbrNewsBySourceindex($n)>0){   	?>
				...
				<footer style="margin-left: 40%"  >
					<?php if ($n!="General Culture") { $srcc=$n;
					}else{$srcc="Culture"; } ?>
				...
				<div class="row" > 
					...
					<div class="col-xs-12 col-sm-12 col-md-4" style="padding-bottom: 60px;" >  
						...
						if(v5newspublished::nbr_news_without_images2()>0) {  
							...
							?>
							<aside><br>
								<div class="line" style="margin: 0px 0px;"><div>ニュース</div></div>
														...
														<div class="detail">  
															<div class="category">
																<a>
																	...
																	<b><?php echo utilisateursModel::type($typesection); ?></b>
																</a>
															</div>   
