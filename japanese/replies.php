                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">返信の権利</li>
                            </ol>
                            <h1 class="page-title">返信の権利</h1>
                              ...
                              <div class="details">
                                        ...
                                        <div class="detail" style="float: left;">
                                            ...
                                            <div style="margin-left: 10px; float: left;  "><a class="right_of_reply_news_link"
                                                                                                                              target="_blank" href="news_reply.php?news=<?=$news['id']?>" >返信権 <img src="images/microphone.png" alt="Microphone"></a></div>
