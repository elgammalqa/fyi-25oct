...
<script async defer data-website-id="afc1b19c-5319-4097-8747-3b05933578c7" src="https://www.fyipress.net/umami.js"></script>
	...
	<body class="skin-orange">
		...
		<div class="container" id="help">
			<h4 style="color: #3da0ca;">1- ダウンロードマネージャを開き、オプションに移動</h4>
			<br>
			<img src="images/1.jpg">
			<hr>
			<h4 style="color: #3da0ca;">2- オプションからファイルタイプを選択</h4>
			<br>
			<img src="images/2.jpg">
			<hr>
			<h4 style="color: #3da0ca;">3- ファイルタイプから削除（PDF）拡張子画像に示すように、[OK]を押します</h4> 
			<br>
