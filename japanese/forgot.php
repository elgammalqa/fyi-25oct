						...
						<div class="box-body">
							...
							<form method="post" >
								...
								<div class="form-group text-right">
									<button class="btn btn-primary btn-block" name="reset" >パスワードを再設定する</button>
								</div>
   ...
   当社のウェブサイトを訪問                
                    ...
                    <span style='font-size: 19px; padding: 20px;  font-family: Helvetica; line-height: 150%; text-align: left; color: #505050;' > Copyright © FYI Press, 全著作権所有.  </span> 
				                ...
				                if ($mail->send()) {
				                    ...
				                    echo '<script> swal("パスワード！ ","メールの受信トレイを確認してください！","success");</script>'; 
				               } else{
				                    echo '<script> swal("パスワード！ ","何かが起こった！もう一度お試しください!","warning");</script>';
				               }
							 	}else{
							 		 echo '<script> swal("サブスクリプション！ ","あなたは購読していません!","warning");</script>';
							 	}
							 }
