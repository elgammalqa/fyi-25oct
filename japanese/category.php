...
<script async defer data-website-id="afc1b19c-5319-4097-8747-3b05933578c7" src="https://www.fyipress.net/umami.js"></script>
    ...
    if($_GET['id']!="News"&&$_GET['id']!="Arts"&&$_GET['id']!="Sports"&&$_GET['id']!="Culture"&&$_GET['id']!="Technology"&&$_GET['id']!="Economy"&&$_GET['id']!="Health"){ ?>								<script>
		  ...
		  <div class="container">
		    <div class="row">
		      <div class="col-md-8 text-left">  
								<div class="row">
						          <div class="col-md-12">
						            ...
						            <h1 class="page-title">カテゴリ: 
						            	<?php echo  utilisateursModel::type($source); ?></h1>
						            <p class="page-subtitle">カテゴリを持つすべての記事を表示 <i>
						            	<?php echo utilisateursModel::type($source); ?></i></p>
							          </div>
							    </div>
							    <div class="line"></div>
							    <div class="row">
					  ...
					  ?>
				          <article class="col-md-12 article-list">
                            ...
                            <a style="color:black;" target="_blank" href="news_reply.php?news=<?= $news['id'] ?>&r=<?=$news['rank']?>">
                                返信権 <img src="images/microphone.png">
                            </a>
                                        </span>
				                </div> 
				              </div>
			 ...
			 <div class="col-md-4 sidebar" id="sidebar">
						<aside>
							<br>
							<h1 id="ptop" class="aside-title">最近のニュース</h1>
