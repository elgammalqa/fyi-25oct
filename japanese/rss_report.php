			...
			<div class="container">
				<div class="row"> 
                  ...
                  <div class="col-md-8">
		            ...
		            <div style="padding-left: 50px; padding-right: 50px;" >
		            	 <div class="form-group">
				            <label for="sel1">レポートの種類 :</label>
				              <select required="required" name="typee" class="form-control" id="sel1"> 
				                <option value="性的コンテンツ" >性的コンテンツ</option>
				                <option value="暴力的なコンテンツ" >暴力的なコンテンツ</option>
				                <option value="悪い言葉" >悪い言葉</option>
				                <option value="ヘイトスピーチ" >ヘイトスピーチ</option>
				                <option value="乱用" >乱用</option>
				              </select>
				          </div>
				          <div class="form-group">
				            <label for="pwd">その他の :</label>
				            <textarea name="other" rows="5" cols="20" class="form-control" placeholder="その他の ....." ></textarea> 
				         </div>
				         <div class="modal-footer">
				          <button type="submit" name="back" class="btn btn-primary" data-dismiss="modal">バック</button>
				          <button type="submit" name="send" class="btn btn-success" data-dismiss="modal">送る</button>
				        </div>  
		            </div>
		            </form>
		            	<?php   
		          ...
		          <?php   }
                        ...
                        <?php  }else{ ?> 
                        	<script> 
                        	      swal("注意!","レポートは追加されません！ あなたはすでにこのコメントを報告しています","warning");
                            </script> 
		           		<?php }  
		           	}//id c
