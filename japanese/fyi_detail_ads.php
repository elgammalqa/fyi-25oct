                             ...
                             if($state_logo==1){
                                if($uploadOk==1){
                                     ...
                                     <?php   }
                                            ...
                                            $msg=null;
                                         if($size_error==1) $msg.='ファイルサイズは以下にする必要があります '.$maxsize.' MB\n';
                                             if($checkexistedeja==1) $msg.='ファイルが既に存在する場合は、ファイル名を変更してやり直してください\n';
                                            if($typeimage==1) $msg.='申し訳ありませんが、単に jpg、jpeg、png、gif、ac-3、mp3、mp4、flk、mkv の、mpeg & webm 形式を受け入れる\n';
                                            if($fin==1) $msg.='ファイルのアップロード中にエラーが発生しました.\n';
                                            $msg.="コメントは追加されません";
                                            ?>
                                            <script>
