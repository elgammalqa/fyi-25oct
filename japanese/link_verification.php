						...
						<div class="box-body">
							...
							<form method="post" >
								...
								<div class="form-group text-right">
									<button class="btn btn-primary btn-block" name="reset" >確認リンクを送信する</button>
								</div>
								<div class="form-group text-center">
									<span class="text-muted">ログインに戻る?</span> <a href="login.php">ログイン</a>
								</div>
							</form>
							<?php
            	...
            	<td>
                    ...
                    <span style='font-size: 19px; padding: 20px;  font-family: Helvetica; line-height: 150%; text-align: left; color: #505050;' > Copyright © FYI Press, 全著作権所有.  </span> 
				                ...
				                if ($mail->send()){
				                    ...
				                    echo '<script> swal("パスワード !","あなたのメールアドレスを確認してください!","success");</script>';
				                }else{
				                    echo '<script> swal("パスワード  !","何か間違ったことが起こった！もう一度お試しください!","warning");</script>';
				                }

				                }else{ // email confirmed
				                	 echo '<script> swal("Eメール !","メールアドレスは既に確認済みです!","warning");</script>';
							 	}

							 	}else{//email not existe
							  echo '<script> swal("購読 !","あなたは購読していません!","warning");</script>'; 
							 	}
							 }
