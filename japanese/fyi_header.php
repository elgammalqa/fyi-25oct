	...
	@media only screen and (min-width: 991px) { 
		...
		<?php }else {  ?>
			#colorblack  li a{
				color: white;
				font-size: 15px;  letter-spacing: 2px; font-weight: 700;
                line-height: 32px;  padding-top: 16px; padding-right: 55px;
			}
	   <?php } ?> 
						...
						<ul id="colorblack" class="nav-list">
						 <?php if(isMobile()){ ?>
							<li style="background-color: red; " class="backk" ><a
								style="  font-size: 30px; color:#fff; border-bottom: none !important; ">バック <i style="text-align: left; font-size: 30px;" class="ion-ios-arrow-forward"></i></a></li>
							 <?php }else{ ?>
							...
							<!--
							<li><a target="_blank" href="favorite_countries.php"  >好きな情報源</a></li>
							-->
							<?php if ($log==false) {  ?>
				    ...
				    <div id="menu-lists">
					 ...
					 <?php if(isMobile()){ ?>
							<li style="background-color: red; " class="backk" >
								<a style="  font-size: 30px; color:#fff; border-bottom: none !important; "> バック <i style="text-align: left; font-size: 30px;" class="ion-ios-arrow-forward"></i></a></li>
							 <?php } ?>
							<li><a href="fyi.php">ホーム</a></li>
							<li><a href="fyi_category.php?id=News&n=1">ニュース</a></li>
							<li><a href="fyi_category.php?id=Sports&n=1">スポーツ</a></li>
							<li><a href="fyi_category.php?id=Arts&n=1">芸術</a></li>
							<li><a href="fyi_category.php?id=Technology&n=1">技術</a></li>
							<li><a href="fyi_category.php?id=Culture&n=1">一般文化</a></li>
							<li><a href="fyi_library.php?n=1">としょうかん</a></li>
						</ul>
					</div>
					  <?php if(isMobile()){ ?>
                   <div id="menu-lang">
