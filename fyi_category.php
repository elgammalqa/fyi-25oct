									...
									<div class="row">
										<div class="col-md-12">        
											<ol class="breadcrumb">
												...
												<li class="active"><?php echo  $source; ?></li>
											</ol>
											<h1 class="page-title">Category: <?php echo  $source; ?></h1>
											<p class="page-subtitle">Showing all posts with category <i><?php echo $source; ?></i></p>
										</div> 
									</div>
									<div class="line"></div>
									<div class="row">
