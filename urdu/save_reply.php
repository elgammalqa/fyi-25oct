                                    ...
                                    if (!in_array($file_extension, $allowed_image_extension)) {
                                        ...
                                        if (ceil($_FILES['file-3']['size'] / 1048576) > $maxsize) {
                                            ...
                                            if (move_uploaded_file($_FILES["file-3"]["tmp_name"], $target_file)) {
                                                ...
                                                echo 'فائل اپ لوڈ کرنے میں ایک خامی تھی ، براہ کرم دوبارہ کوشش کریں';
                                            }
                                    ...
                                    ?>
                                        <div class="row">
                                            <div class="col-xs-12 text-center">
                                                <h2>ہو گیا</h2>
                                                <h3>جائزہ لینے کے بعد ہی اسے شائع کیا جائے گا
                                                    گا
                                                    انظر أيضًا
                                                    گانا
                                                </h3>
                                    ...
                                    <?php
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 text-center">
                                                ...
                                                <h3>براہ کرم دوبارہ کوشش کریں</h3>
                                            </div>
                                        </div>
                                    <?php
                                    }
