...
<script async defer data-website-id="afc1b19c-5319-4097-8747-3b05933578c7" src="https://www.fyipress.net/umami.js"></script>
	...
	<body class="skin-orange">
		...
		<div class="container" id="help">
			<h4 style="color: #3da0ca;">1-آپ کے ڈاؤن لوڈ کے خطرے کو کھولیں اور اختیارات میں جائیں</h4>
			<br>
			<img src="images/1.jpg">
			<hr>
			<h4 style="color: #3da0ca;">2- اختیارات سے فائل کی اقسام منتخب کریں</h4>
			<br>
			<img src="images/2.jpg">
			<hr>
			<h4 style="color: #3da0ca;">3- فائل کی قسم حذف سے (پی ڈی ایف) کی توسیع سے اس تصویر میں دکھایا گیا ہے اور OK پر دبائیں</h4> 
			<br>
