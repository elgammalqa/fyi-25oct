        ...
        <div class="row">
            ...
            <div class="col-md-8">
                    ...
                    <article class="article main-article">
                        <div class="main" style="padding-top: 0px !important;">
                            ...
                            <div class="xtypedate">
                                ...
                                <span class="xdate">
							پوسٹ کیا گیا    <?php real_news_time($news->getpubDate()); ?>
							</span>
                            </div>
                            <div class="xdetail2">
                ...
                <div class="comments">
                    <form method="post">
                        <?php if ($log == false) { ?>
                            <h3 style="text-align: center; padding-top: 40px; "> براہ کرم <a href="login.php"> سائن ان کریں </a> تبصرہ کرنے کے لئے </h3>
                                ...
                                <?php if ($log == true) { ?>
                                    <div style="border: none;" class="modal-footer">
                                        <a href="<?php echo 'detaill.php?id=' . $id_art_actuel . '&r=' . $comment['id']; ?>">
                                            <button type="button" class="btn btn-primary xreply" data-dismiss="modal"> جواب
                                            </button>
                                        </a>
                    ...
                    <form style="padding-bottom: 50px;" enctype="multipart/form-data" method="post" class="row">
                        ...
                        <div class="form-group col-md-4 col-xs-12 " style="float: left;">
                            <input value="  تبصرہ " name="send" type="submit" class="btn btn-primary form-control "
