                                ...
                                if($uploadOk==1){  
                                     ...
                                     <?php   }
                                         ...
                                         if($size_error==1) $msg.='فائل کا سائز کم سے کم ہونا ضروری ہے '.$maxsize.' MB\n'; 
                                             if($checkexistedeja==1) $msg.='فائل پہلے سے ہی موجود ہے، براہ کرم فائل کا نام تبدیل کریں اور دوبارہ کوشش کریں\n'; 
                                            if($typeimage==1) $msg.='افسوس، صرف jpg، jpeg، png، gif، ac3، mp3، mp4، flk، mkv، mpeg، webm format کی قبول کریں.\n'; 
