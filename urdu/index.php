            ...
            <div class="row">
                ...
                { ?>
                    <div class="col-md-8 col-sm-12 col-xs-12 ">
                        ...
                        echo ads_link_comments($news['id'], $log, $linkv, 'تبصرے کی تعداد'); ?>
						</span>
                                            <span style="padding-right: 20px; float: right;">
                            <a style="color:black;" target="_blank" href="news_reply.php?news=<?= $news['id'] ?>&r=<?= $news['rank'] ?>">
                                جواب کا حق <img src="../images/microphone.png">
                            </a>
                        </span>
                                        </div>
                                    </div>
						...
						<a style=" color: black !important;">
							...
							<?php real_news_time($news['pubDate']); ?>
                                        ...
                                        <span style="padding-right: 20px; float: right;">
						<?php echo link_comments($news['id'], $log, $linkv, 'تبصرے کی تعداد', $news['rank']); ?>
						</span>
                                        <span style="padding-right: 20px; float: right;">
                            <a style="color:black;" target="_blank" href="news_reply.php?news=<?= $news['id'] ?>&r=<?=$news['rank']?>">
                                جواب کا حق <img src="../images/microphone.png">
    ...
    <section class="best-of-the-week " style="padding-bottom: 0px;padding-top: 40px;">
        <div class="container">
            <h1 style="margin-bottom: 60px;">
                ...
                <div class="text" style="float: right;"> ویڈیوز</div>
            </h1>
                            ...
                            <div class="padding">
                                ...
                                <div class="detail float_right ">
                                    ...
                                    <div style="padding-left: 15px;">
                                        <h6><a><?php echo $typesectionv; ?></a></h6>
                                    </div>
                                    <span style="padding-right: 20px; float: right;">
                            <a style="color:black;" target="_blank" href="news_reply.php?news=<?= $news['id'] ?>&r=<?=$news['rank']?>">
                                جواب کا حق <img src="../images/microphone.png">
        ...
        <footer style="text-align: center; ">
            ...
            <a class="btn btn-primary more "
               href="category.php?id=<?php echo $srcc; ?>&n=1" style="padding-top: 4px;">
                <div style="font-size: 20px; "> مزید پڑھیں</div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4" style="padding-bottom: 60px;">
                                    ...
                                    <div class="tab-pane active" id="recomended">
                                        ...
                                        <footer>
                                            <a target="_blank" class="btn btn-primary more pull-right " href="rssall.php?id=1">
                                                <div style="font-size: 18px;"> مزید پڑھیں</div>
                        ...
                        if (news_publishedModel::pdfcount() > 0) { ?>
                            ...
                            <div class="body-col vertical-slider" data-max="4" data-nav="#hot-news-nav" data-item="article">
                                ...
                                foreach ($query as $news) { ?>
                                    <article class="article-mini" style="background-color: white; direction: rtl; height: 140px; margin-bottom: 15px;">
                                        <div class="inner">
                                            <figure style="float: right; width: 110px; height: 120px">
                                                <a target="_blank" href="detail.php?id=<?php echo $news['id']; ?>">
                                                    <img preload="none" style="width: 110px; height: 120px" src="images/img/pdf.jpg" alt="Image">
                                                </a>
                                            </figure>
