            ...
            if(isset($_POST['search'])){
                if (isset($_POST['date1'])&&isset($_POST['countries'])) { 
                      if ($_POST['countries']!="Select") {
                          $cc=$_POST['countries'];    $p = explode('-', $_POST['date1']);   
                                 $d1=$p[2]."/".$p[1]."/".$p[0];  
                          if (userModel::traffic_date_country($_POST['date1'],$cc)!=null) { ?>
                 ...
                 <table class="table table-striped jambo_table bulk_action">
                      ...
                      <tbody>  
                        <tr class="headings"> 
                          ...
                          <th  class="column-title"> <?php echo $cc; ?> </th>  <th  class="column-title"> 
                            <span style="color: red; font-size: 15px; "  >
                              <?php echo userModel::traffic_date_country($_POST['date1'],$cc); ?>
                            </span>   
                          </th>   
                        </tr> 
                      </tbody> 
                       ...
                       <?php   } else {
                           echo '<script>swal("No Visitor","There is No Visitors From '.$cc.' On '.$d1.'","warning")</script>';
                          }
                      }else{
