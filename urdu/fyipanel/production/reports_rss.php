                    ...
                    <table id="example" class="table table-bordered" cellspacing="0" width="100%">
                      ...
                      $news = new reportModel();
                        ...
                        foreach($query as $news){  ?>     
                            ...
                            <td >   
                              <?php
                              $actual_link = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http")."://".$_SERVER['HTTP_HOST']."/urdu/iframe.php?link=".reportModel::rss_getNewsTitle($news['id_news'])."&id=".$news['id_news'];
                              ?> 
