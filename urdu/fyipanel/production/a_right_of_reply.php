...
'$id'");
                        ...
                        if(isset($_POST['handle_reply'])){
                            ...
                            switch ($publish_status){
                                case '1':
                                    $published = true;
                                    $mail_feedback_message = 'جواب صحیح پوسٹ کرنے کے لئے منظور';
                                    break;
                                case '0':
                                    $mail_feedback_message = 'پوسٹ بیک درست نہیں ہے';
                            }
                            ...
                            if($q->execute()){
                                ...
                                $mail->Subject="FYIPress جواب کے دائیں جائزہ لیں";
                                $name = $row['name'];
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                            <td style='font-size: 19px; padding: 20px;  font-family: Helvetica; line-height: 150%; text-align: right;' >
                                               ...
                                               <br> <br>
                                               سائٹ میں FYIPress      <br><br>
                                               اس جواب کے جو آپ نے شامل کیا ہے اس کا جائزہ لیا گیا ہے <br>
                                               ".$mail_feedback_message." 
                                                <br>
                                                ".$feedback." <br> 
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    if($news_published){
                                        ?><a href="<?=$domain?>urdu/detail.php?id=<?=$news_id?>" target="_blank"><?=$row1['title']?></a><?php
                                    }
                                    else{
                                        if($reply_to_news && !$external){
                                            ?><a href="<?=$domain?>urdu/iframe.php?link=<?=$row1['link']?>&id=<?=$news_id?>" target="_blank"><?=$row1['title']?></a><?php
                                        }
