...
<script async defer data-website-id="afc1b19c-5319-4097-8747-3b05933578c7" src="http://205.134.254.209:3000/umami.js"></script>
    ...
    <style type="text/css">
        ...
        .thumb-image{float:none;width:180px;position:relative;padding:5px; margin: 0 auto}
        #image-holder1, #image-holder2{text-align: center}
        .tox-tinymce-aux{
...
if (isset($_GET['news']) && !empty($_GET['news']) && isset($_GET['r']) && ($_GET['r'] == 1 || $_GET['r'] == 2)) {
    ...
    <br>بشرط مراعاة الآداب العامة <br>وسياسة الموقع . يوفر موقع إف واي<br> آي برس لك حق الرد على أي خبر أو<br> مقال  يتم نشره لديه .. ولكن ما يتم<br> نشره هو على مسؤولية من قام<br> بالنشر دون أي مسؤولية على إف<br> واي آي برس  </span>
                                            ...
                                            <div class="col-xs-12" id="date" style="margin-bottom: 15px;">
                                                <label for="date">اس کے جواب میں جو شائع ہوا تھا</label>
                                            ...
                                            <div class="col-xs-12" id="news_title" style="margin-bottom: 15px;">
                                                <label for="news_title">عنوان دیا گیا</label>
                                            ...
                                            if ((int)$_GET['r'] == 2) {
                                                ...
                                                <div class="col-xs-12" id="source" style="margin-bottom: 15px;">
                                                    <label for="source">اشاعت کا نام</label>
                                            ...
                                            <div class="col-xs-12" id="link" style="margin-bottom: 15px;">
                                                <label for="link"><span class="required"></span>آپ جس کا جواب دے رہے ہیں اس کا لنک چسپاں کریں</label>
                                                <input type="text" name="link" value="" class="form-control">
                                            </div>

                                            <div class="col-xs-12" id="phone" style="margin-bottom: 15px;">
                                                <label for="phone">فون کا جواب دینا</label>
                                                <input type="text" name="phone" value="" class="form-control">
                                            </div>

                                            <div class="col-xs-12" id="email" style="margin-bottom: 15px;">
                                                <label for="emai">ای میل</label>
                                                <input type="text" name="emai" value="<?= $d->getemail() ?>" required class="form-control" disabled>
                                            </div>

                                            <div class="col-xs-12" style="margin-bottom: 15px;">
                                                <label for="message_to_admin">جواب دہندہ کا FYI پریس کو پیغام (شائع نہیں ہوا)</label>
                                    ...
                                    <div class="form-group col-xs-12 col-md-8" style="text-align: right; direction: rtl; margin-bottom: 0;">

                                        <div class="row checkboxes">

                                            <div class="col-xs-12 col-sm-3">
                                                <a href="replies.php?id=<?= $row['type'] ?>&n=1" class="display_replies_link">جوابات کا جائزہ لیں</a>
                                            </div>
                                        ...
                                        <div class="row formdata" style="position: relative;">
                                            ...
                                            <div class="col-xs-11 col-md-10 col-md-push-2" style="margin-bottom: 12px;">
                                                <label for="username"><span class="required"></span>جواب ایڈریس</label>
                                                <input type="text" name="title" value="" id="title" class="form-control" required>
                                            </div>
                                            <div class="col-xs-11 col-md-10 col-md-push-2">

                                                <label for="username"><span class="required"></span>آپ کا نام</label>
                                                <input type="text" name="username" value="<?= $d->getname() ?>" id="username" class="form-control" disabled required>
                                            </div>

                                            <input value="بھیجیں" name="send_right_of_reply" type="submit" class="btn btn-primary form-control">
                                            ...
                                            <div class="col-xs-6 col-md-6">
                                                <div class="box file_upload">
                                                    ...
                                                    <label for="file-3"><span><i class="fa fa-upload"></i> مرکزی تصویر کا جواب دیں (اختیاری)</span></label>
                                                </div>
                                            ...
                                            <div class="col-xs-6 col-md-6">
                                                <div class="box file_upload">
                                                    <input type="file" name="file-4" id="file-4" class="inputfile inputfile-4" data-multiple-caption="{count} files selected"
                                                           accept="image/png, image/jpeg"/>
                                                    <label for="file-4"><span> <i class="fa fa-upload"></i> جواب کی تصویر (اختیاری)</span></label>
                                                </div>
                                            ...
                                            <div class="col-xs-12">
                                                <div class="box boxhint">
                                                    <label ><span>کسی بھی مرحلے پر آپ لائنوں کے درمیان فوٹو یا ویڈیو شامل کرسکتے ہیں
</span></label>
                                                </div>
                                            </div>

                                            <div class="col-xs-12" style="margin-top: 25px;">
                                                <label for="myTextField2">جواب دیں</label>
                                                <textarea style="text-align: right;" id="myTextField2" class="form-control" name="myTextField2"
                                                ></textarea>
                                            </div>
        ...
        <script>tinymce.init({
                ...
                images_upload_base_path: 'https://www.fyipress.net/urdu/uploaded_images',
                ...
                /* toolbar */
                toolbar: "insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link | print " +
                    "preview media fullpage | forecolor backcolor emoticons responsivefilemanager",
                image_advtab: true ,
                external_filemanager_path:"/urdu/filemanager/",
