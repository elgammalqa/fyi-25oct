...
<script async defer data-website-id="afc1b19c-5319-4097-8747-3b05933578c7" src="https://www.fyipress.net/umami.js"></script>
    ...
    <style>
        ...
        .source_top_row a{
            float: right; font-family: 'Droid Arabic Kufi', serif; width: 100%;
        }
        ...
        h6{font-family: 'Droid Arabic Kufi', serif; font-size: 14px; text-align: right}
        ...
        .card-header.card-header-default.card-header-icon h5 a{font-family: 'Droid Arabic Kufi';}

        input[type=submit] {
            width: 100px !important; height: 35px; border: 0;  line-height: 0;
            font-family: 'Droid Arabic Kufi', serif; font-size: 14px; margin-bottom: 20px;
            color: #fff ;
            padding: 0 ;
            background: #fe0002 ;
        }
...
<div class="content container">
    ...
    <div class="row source_top_row">
        ...
        <div class="col-xs-6 col-sm-4 col-md-2">
            <a href="favorite_countries.php" class="btn btn-md btn-primary <?=(!stristr($page,'user_')) ? 'selected' : '';?>">تمام ریاستیں</a>
        </div>
        <div class="col-xs-6 col-sm-4 col-md-2">
            <a href="user_favorite_countries.php" class="btn btn-md btn-primary <?=(stristr($page,'user_')) ? 'selected' : '';?>">میرے ذرائع</a>
        </div>
    </div>

    <div class="container stats" style="display: none"><br><h1 style="text-align: right;"  >   ممالک کی فہرست    </h1><hr></div>
        ...
        <form method="post" action="">
            ...
            <div class="row">
                <div class="col-xs-12 text-center">
                    <input type="submit"  name="Enregistrer" value=" محفوظ کریں ">
                </div>
            </div>
        </form>
    </div>
...
if ($log) {
    ...
    foreach ($all_user_sources as $source) {
        $topic = 'ur-' . str_replace(' ', '__', $source['country']) . '-' . str_replace(' ', '__', $source['source']);
    ...
    foreach ($selected_sources as $src) {
        ...
        $topic = 'ur-' . str_replace(' ', '__', $country) . '-' . str_replace(' ', '__', $source);
        $fcm = new WebFCMToTopic();
