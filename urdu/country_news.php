                ...
                <div class="row">
                    <div class="col-md-12 float_right">
                        <ol style="list-style: none; ">
                            ...
                            <li class="float_right fs_cat" class="active"><?php echo utilisateursModel::type($source).' '.$country; ?></li>
                        </ol>
                    </div>
                </div>
                <div class="line"></div>
                                        ...
                                        <div class="detail" style="float: right;">
                                            ...
                                            <div class="time ">
                                                ...
                                                <div class="time right_of_reply">
                                                                    <span class="float_rightd">
                                                                        <a href="news_reply.php?news=<?=$news['id']?>&r=<?=$news['rank']?>">جواب کا حق<img src="../images/microphone.png" alt=""></a>
                                                                    </span>
                                                </div>
