			 ...
			 <div class="col-md-4 sidebar" id="sidebar"> 
		      ...
		      <div class="col-md-8 text-left"> 
								<div class="row"> 
						          <div class="col-md-12 float_right">        
						            <ol   style="list-style: none; " >
						              <li class="float_right fs_cat "  ><a style="font-family: 'Droid Arabic Kufi', serif; letter-spacing: 0px;"  href="fyi.php">گھر</a>
						              </li>
					 ...
					 foreach($req as $news){ 
										    ...
										    $source2=utilisateursModel::type($news['type']);   
						  ?>
				            ...
				            <div class="inner">
				              ...
				              <div class="details mar_right"> 
				    					...
				    					<div class="detail" style="float: right;" >
				    						<div class="category" style="padding-left: 15px;">  
				    							<a class="float_rightd" >
				    								<?php echo $source2; ?> 
				    							</a>
				    						</div>
				    						<div class="time " style="padding-left: 15px;">
											...
											<?php  if($log){ 
													if(v5newspublished::already_read($news['id'])){
													echo '<i class="fa fa-circle" style=" color: green; margin-top: 10px;" aria-hidden="true"></i>';
													}else{
													echo '<i class="fa fa-circle" style=" color: red; margin-top: 10px;" aria-hidden="true"></i>';
													}
												}//log
											 ?>  
										</span> 
