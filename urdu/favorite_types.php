...
<script async defer data-website-id="afc1b19c-5319-4097-8747-3b05933578c7" src="https://www.fyipress.net/umami.js"></script>
  ...
  <div class="content">
    <div class="container stats">
      <br> 
      <h1 style="text-align: right;" > اپنی پسندیدہ اقسام کا انتخاب کریں  </h1> <hr>
    </div> 
...
<input type="submit" class="green" name="Enregistrer" value=" بچاؤ   " style="font-size: 26px; margin-right: 60px; " >
</form>  
<br><br>
</div></div>  
      <?php  
    ...
    <script>  
       location.href="favorite_types.php?country=<?php echo $pays."&source=".$source; ?>";
                ...
                echo "<script> alert(' آپ کو کم سے کم پانچ ذرائع کی پیروی کرنا ضروری ہے  '); </script>";
              }  
