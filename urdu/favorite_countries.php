...
<body> 
    <div class="content container">
        ...
        <div class="container stats"><br><h1 style="text-align: right;"  >   ممالک کی فہرست   </h1><hr></div>
        <div class="container-fluid">
          ...
          ?>
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
             ...
             <?php } 
              ...
              if(isset($_COOKIE['urdu_sources'])){ //there is a cookie
         ...
         $GLOBALS['nb_sources_not_checked']+=v4Utilisteurs::nb_rss_sources_of_country($country['country']);
              ...
              if($GLOBALS['nb_sources_not_checked']>=5){//ok we can continue
                  ...
                  if($log==false){
                      if(isset($_COOKIE['urdu_sources'])){
                      setcookie('urdu_sources', json_encode($data),time()+31556926 ,'/');
                    }else{
                      setcookie('urdu_sources', json_encode($notchecked),time()+31556926 ,'/'); 
                    }
                  }
                  ?>
                ...
                echo "<script> alert('آپ کو کم از کم پانچ وسائل پر عمل کرنا چاہئے'); </script>";
              }  
