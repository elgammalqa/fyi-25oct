...
<script async defer data-website-id="afc1b19c-5319-4097-8747-3b05933578c7" src="https://www.fyipress.net/umami.js"></script><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<body class="skin-orange">
					...
					<div class="box box-border">
						<div class="box-body">
							...
							<form method="post" >
								...
								<div class="form-group">
									<label class="fw">Mot de passe</label>
									<input placeholder="le mot de passe doit comporter au moins six caractères comprenant (un caractère ou une lettre) et un chiffre" required="required" type="password" name="password" class="form-control">
								</div>
								<div class="form-group">
									<label class="fw">Confirmez le mot de passe</label>
									<input placeholder="le mot de passe doit comporter au moins six caractères comprenant (un caractère ou une lettre) et un chiffre" required="required" type="password" name="confirm_password" class="form-control">
								</div> 
								...
								<div class="form-group text-center">
									<span class="text-muted">Vous avez déjà un compte?</span> <a href="login.php">S'identifier</a>
								</div>
							</form> 
							<?php if(isset($_POST['register'])){  
							     ...
							     <?php
		                            ...
		                            if ($NumbresOfCaracteres<6) {
		                              $msgg='le mot de passe doit comporter au moins six caractères comprenant (un caractère ou une lettre) et un chiffre';
		                            }else{
		                            if ($CountOfNumbers>=1) { 
		                            if ($NumbresOfCaracteres-$CountOfNumbers<=0)  {   $msgg='le mot de passe doit comporter au moins six caractères comprenant (un caractère ou une lettre) et un chiffre';
		                             }
		                             }else {
		                                $msgg='le mot de passe doit comporter au moins six caractères comprenant (un caractère ou une lettre) et un chiffre';
		                             }
        ...
        <tbody> 
            ...
            <tr> 
                ...
                Salut $name, <br> <br> Bienvenue à FYI Press .  <br><br>
			        Pour activer votre compte et vérifier votre adresse e-mail,<br>
                    veuillez cliquer sur le lien ci-dessous : <br> <br> <span style='padding-left: 100px;' ></span>
            ...
            <tr>  
            	<td>
                    ...
                    <span style='font-size: 19px; padding: 20px;  font-family: Helvetica; line-height: 150%; text-align: left; color: #505050;' >   Copyright  © FYI Press, Tous les droits sont réservés.  </span> 
                </td>
            </tr>
  ...
  "; 
				                if ($mail->send()){ 
				                    ...
				                    echo '<script> swal("Mot de passe !","Vous avez été enregistré! S il vous plaît vérifier votre email!","success");</script>'; 
				                } else{ 
				                    echo '<script> swal("Mot de passe  !","Quelque chose s est mal passé! Veuillez réessayer!","warning");</script>';
				                }

						               }else{  ?>
						          <script>
			 swal("Mauvais mot de passe!","lles 2 mots de passe ne sont pas identiques","warning")
						          </script>
				      <?php } //
			     }else { // not string   ?>
						          <script>
