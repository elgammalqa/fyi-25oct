 ...
 <div class="comment-list">   
								  ...
								  <?php } else if(!commentsModel::rss_HisReply($reply['id'],$user_email) && 
								   commentsModel::rss_reply_already_reported($reply['id'],$user_email)){ ?> 
 									<button disabled="" type="button"
 										 class="btn btn-danger xreporten2" data-dismiss="modal">Signaler
								     </button> 
 									<?php } ?> 
								    </div>   
								   <?php  } // log true ?>
		...
		<?php	if($log){  ?>
                        ...
                        // Check CFE $uploadOk is set to 0 by an error
									if ($uploadOk == 1) {  
										if (isset($_GET['r'])&&!empty($_GET['r'])) { 
											$ImageName=(string)repliesModel::rss_nbr_news_with_images()+1; 
										}else{
...
<script type="text/javascript">
	...
	function f11(){ 
		window.location.replace('iframee.php?link=<?php echo $clink;?>&id=<?php echo $id_art_actuel; ?>'); 
	}
