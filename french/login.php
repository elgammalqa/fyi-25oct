						...
						<div class="box-body">
							...
							<form method="post" >
								...
								<div class="form-group"> 
									...
									<a href="forgot.php" class="pull-right">Mot de passe oublié ?</a>
									<!-- href="forgot.php" -->
								</div>
								<br>
								...
								<div class="form-group text-center">
									<span class="text-muted">vous n'avez pas de compte ?</span> <a href="register.php"> Registre </a> <br>
									<span class="text-muted">
										Vous n'avez pas reçu votre lien de vérification : <br>
									</span> <a href="link_verification.php">Envoyer à nouveau</a>
								</div>   
							</form>  
                            ...
                            ?>
                              ...
                              $_SESSION['user_auth']=array('user_pass'=>$user->getpassword(),'user_email'=>$logg);    $user->active_status($logg); ?>
                                  <script> window.location.replace('home.php'); </script><?php
	                      	 	...
	                      	 	echo '<script> swal("Accès refusé!","veuillez vérifier votre email - nous avons envoyé un message de confirmation ou cliquez sur le lien Envoyer à nouveau","warning");</script>';
	                      	 }  

                    }else{ ?>
                      <script> swal("Accès refusé!","Email ou mot de passe faux !! réessayer","warning");</script>
             <?php  }
            }else{ ?>
                  <script> swal("Accès refusé!","Email ou mot de passe faux !! réessayer","warning");</script>
      <?php }  
