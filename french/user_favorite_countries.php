...
<div class="content container">
    ...
    <div class="row source_top_row">
        ...
        <div class="col-xs-6 col-sm-4 col-md-2">
            <a href="favorite_countries.php" class="btn btn-md btn-primary <?=(!stristr($page,'user_')) ? 'selected' : '';?>">Tous les pays</a>
        </div>
        <div class="col-xs-6 col-sm-4 col-md-2">
            <a href="user_favorite_countries.php" class="btn btn-md btn-primary <?=(stristr($page,'user_')) ? 'selected' : '';?>">Mes sources</a>
        </div>
    </div>

    <div class="container stats" style="display: none"><br><h1 style="text-align: right;"  >   Liste des pays</h1><hr></div>
        ...
        <form method="post" action="">
            ...
            <div class="row">
                <div class="col-xs-12 text-center">
                    <input type="submit"  name="Enregistrer" value=" sauver ">
                </div>
            </div>
        </form>
    </div>
...
if ($log) {
    ...
    foreach ($all_user_sources as $source) {
        $topic = 'fr-' . str_replace(' ', '__', $source['country']) . '-' . str_replace(' ', '__', $source['source']);
    ...
    foreach ($selected_sources as $src) {
        ...
        $topic = 'fr-' . str_replace(' ', '__', $country) . '-' . str_replace(' ', '__', $source);
        $fcm = new WebFCMToTopic();
