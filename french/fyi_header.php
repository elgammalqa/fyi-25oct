	...
	@media only screen and (min-width: 991px) { 
		...
		<?php }else {  ?>
			#colorblack  li a{
				color: white;
				font-size: 15px;  letter-spacing: 2px; font-weight: 700;
                line-height: 32px;  padding-top: 16px; padding-right: 45px;
			}
	   <?php } ?>
					...
					<div style="background-color: #55abcd;" id="menu-list">
					    ...
					    <?php if(isMobile()){ ?>
							<li style="background-color: red; " class="backk" ><a 
								style="  font-size: 30px; color:#fff; border-bottom: none !important; ">Retour <i style="text-align: left; font-size: 30px;" class="ion-ios-arrow-forward"></i></a></li>   
					    <?php }else{ ?> 
					    ...
					    <?php } ?>   
							...
							<!--
							<li><a target="_blank" href="favorite_countries.php"  > sources préférées </a></li>
							-->
							<?php if ($log==false) {  ?>
						...
						<?php }else{ ?>
							<li class="dropdown magz-dropdown">
							 ...
							 <ul id="colorblack2" class="dropdown-menu">  
									<li style="width: 265px !important;">
										<a href="resetpass.php" style="width: 260px !important;" >
										    Changer le mot de passe 
									    </a>
									</li> 
									<li class="divider"></li>
									<li><a href="logout.php" style="    width: 260px !important;" >
										 se déconnecter</a></li>
								</ul>
						    </li> 
						<?php } 
				...
				<div class="container"> 
				 <?php if(!isMobile()){ ?>
					<div class="brand">
						<a href="index.php">
							...
							src="images/fyipress.png"   alt="fyi press Logo">
						</a>
					</div>  
					<div class="brand">
						<a href="fyi.php">
							<img  style="width: 50px; height: 30px;" 
							src="../images/fyipress2.png"   alt="fyi press Logo">
						</a>
					</div>  
					<?php } ?>

					<div class="mobile-toggle">
						<a href="#" data-toggle="menu" data-target="#menu-lists">
							<i  class="ion-navicon-round" style="color: red;"></i></a>
					</div>
				  
					<div class="mobile-toggle">
						<a href="#" data-toggle="menu" data-target="#menu-list">
							<i  class="ion-android-apps" style="color: red;" ></i></a>
					</div>
				 ...
				 <div id="menu-lists">
				    <ul class="nav-list plm">  
					 <?php if(isMobile()){ ?>
						<li style="background-color: red; " class="backk" >
							<a style="  font-size: 30px; color:#fff; border-bottom: none !important; ">Retour  <i style="text-align: left; font-size: 30px;" 
								class="ion-ios-arrow-forward"></i></a></li>
				    <?php } ?>
							<li><a href="fyi_category.php?id=News&n=1">Actualités</a></li>
							<li><a href="fyi_category.php?id=Sports&n=1">Sport</a></li>
							<li><a href="fyi_category.php?id=Arts&n=1">Arts</a></li>
							<li><a href="fyi_category.php?id=Technology&n=1">Technologie</a></li>
							<li><a href="fyi_category.php?id=Culture&n=1">Culture générale</a></li> 
							<li><a href="fyi_library.php?n=1">Bibliothèque</a></li>  
						</ul>
					</div>
                   ...
                   <div id="menu-lang">
						<ul class="nav-list plm">  
							<li style="background-color: red; " class="backk" >
								<a style="  font-size: 30px; color:#fff; border-bottom: none !important; ">Retour <i style="text-align: left; font-size: 30px;" class="ion-ios-arrow-forward"></i></a></li>
											<li><a class="pl" href="../arabic/index.php" >العربية</a></li>
											<li><a class="pl" href="../urdu/index.php" >ارڈو </a></li>
											<li><a class="pl" href="../home.php" >
											English</a></li> 
