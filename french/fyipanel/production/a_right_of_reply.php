...
'$id'");
                        ...
                        if(isset($_POST['handle_reply'])){
                            ...
                            switch ($publish_status){
                                case '1':
                                    $published = true;
                                    $mail_feedback_message = 'Le droit de réponse a été publié';
                                    break;
                                case '0':
                                    $mail_feedback_message = 'Le droit de réponse a été rejeté';
                            }
                            ...
                            if($q->execute()){
                                ...
                                $mail->Subject="FYIPress - Révision du droit de réponse";
                                $name = $row['name'];
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                            <td style='font-size: 19px; padding: 20px;  font-family: Helvetica; line-height: 150%; text-align: right;' >
                                               ...
                                               <br> <br>
                                               Pour FYIPress      <br><br>
                                               Votre droit de réponse a été examiné <br>
                                               ".$mail_feedback_message." 
                                                <br>
                                                ".$feedback." <br> 
