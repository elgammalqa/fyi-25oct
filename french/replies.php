		    ...
		    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Droit de réponse</li>
                            </ol>
                            <h1 class="page-title">Droit de réponse</h1>
                              ...
                              <div class="details">
                                        ...
                                        <div class="detail" style="float: left;">
                                            ...
                                            <div style="margin-left: 10px; float: left;  "><a class="right_of_reply_news_link"
                                                                                                                              target="_blank" href="news_reply.php?news=<?=$news['id']?>" >Droit de réponse <img src="images/microphone.png" alt="Microphone"></a></div>
                ...
                <?php if(news_publishedModel::nbrhotnews()>0){  ?>
                    <div class="col-md-4 sidebar" id="sidebar">
                        <aside>
                            <br>
                            <h1 id="ptop" class="aside-title">Nouvelles récentes</h1>
