...
ini_set('error_log','LOG_French.log');
                    ...
                    <ul id="colorblack" class="nav-list">
                        <?php if (isMobile()) { ?>
                            <li style="background-color: red; " class="backk"><a
                                        style="  font-size: 30px; color:#fff; border-bottom: none !important; ">Retour <i style="text-align: left; font-size: 30px;"
                        ...
                        <li><a href="favorite_countries.php"> sources préférées </a></li>
                        <?php if ($log == false) { ?>
            ...
            <div class="container">
                ...
                <div id="menu-lists">
                    <ul class="nav-list plm">
                        <?php if (isMobile()) { ?>
                            <li style="background-color: red; " class="backk">
                                <a style="  font-size: 30px; color:#fff; border-bottom: none !important; ">Retour <i style="text-align: left; font-size: 30px;"
                                                                                                                     class="ion-ios-arrow-forward"></i></a></li>
                        <?php } ?>
                        <li><a href="breaking_news.php?n=1">Dernières Nouvelles</a></li>
                        <?php
                        ...
                        ?>
                        <li><a href="category.php?id=News&n=1">Actualités</a></li>
                        <li><a href="category.php?id=Sports&n=1">Sport</a></li>
                        <li><a href="category.php?id=Economy&n=1">Économie</a></li>
                        <li><a href="category.php?id=Health&n=1">Santé</a></li>
                        <li><a href="category.php?id=Arts&n=1">Arts</a></li>
                        <li><a href="category.php?id=Technology&n=1">Technologie</a></li>
                        <li><a href="category.php?id=Culture&n=1">Culture</a></li>
                        <li><a href="library.php?n=1">Bibliothèque</a></li>
                        <li class="dropdown"><a  href="#">Des pays</a>
