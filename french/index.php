...
<script async defer data-website-id="afc1b19c-5319-4097-8747-3b05933578c7" src="https://www.fyipress.net/umami.js"></script>
	...
	<meta name="description" content="fyi Press, fyipress, Actualités, Sport, Technologie, Culture générale, Arts">
	<meta name="author" content="Chatsrun"> 
	<meta name="keyword" content="fyi Press, fyipress, Actualités, Sport, Technologie, Culture générale, Arts"> 
		<!-- Shareable -->
	<meta property="og:title" content="fyi Press, fyipress, Actualités, Sport, Technologie, Culture générale, Arts" />
									...
									foreach($req as $news){  
										...
										<article>
											...
											<div class="time2">
												...
												<?php echo $source; ?> </a> &nbsp;&nbsp;&nbsp;&nbsp;
												<?php real_news_time($news['pubDate']); 
												echo link_comments($news['id'],$log,$linkv,'commentaire','commentaires',$news['rank']); 	?> 
											</div>
                                                <span style="padding-left: 20px; float: left;">
                            <a style="color:black;" target="_blank" href="news_reply.php?news=<?= $news['id'] ?>&r=<?=$news['rank']?>">
                                Droit de réponse <img src="images/microphone.png">
	...
	<div class="col-xs-12 col-sm-12 col-md-4 " id="margin_hotnews" > 
						<?php   	//hot news news  Dernières Nouvelles
					...
					<div class="row" > 
						...
						<div class="col-xs-12 col-sm-12 col-md-4  "   style="padding-bottom: 60px;" >  
							<?php if(news_publishedModel::rsscount2()>0||news_publishedModel::nbr_news_without_images2()>0) {
								$nbnews=$GLOBALS['nb_news_types']*5;  
								?>
								<aside><br>
