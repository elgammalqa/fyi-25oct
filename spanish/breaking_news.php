              ...
              <div class="row">
                  <div class="col-md-12">
                      <ol class="breadcrumb">
                          ...
                          <li class="active">Noticias de última hora</li>
                      </ol>
                      <h1 class="page-title">Noticias de última hora</h1>
                              ...
                              <div class="details  ">
                                        ...
                                        <div class="detail" style="float: left;">
                                            ...
                                            <div class="time right_of_reply">
                                                <span class=" ">
                                                    <a class="right_of_reply_news_link" href="news_reply.php?news=<?=$news['id']?>&r=2">Derecho de respuesta <img src="images/microphone.png" alt=""></a>
                                                </span>
                                            </div>
            ...
            <div class="inner">
              ...
              <div class="details  ">
                        ...
                        <div class="detail" style="float: left;">
                            ...
                            <div class="time right_of_reply">
                                <span class=" ">
                                    <a class="right_of_reply_news_link" href="news_reply.php?news=<?=$news['id']?>&r=<?=$news['rank']?>">Derecho de respuesta <img
                                        ...
                                        <div class="details">
                                            ...
                                            <div class="detail " style="padding-top: 10px;" >
                                                ...
                                                <div style="margin-left: 10px; float: left;  "><a class="right_of_reply_news_link"
                                                                                                  target="_blank" href="news_reply.php?news=<?=$news['id']?>" >Derecho de respuesta<img src="images/microphone.png" alt="Microphone"></a></div>
                                            </div>
                                        </div>
                                    </div>
                                </article>
