...
include '../models/ads.model.php';  
  if(userModel::islogged("Head of Branch")==true){ 
    if(userModel::isLoged_but_un_lock()){
       ...
       if (count($_COOKIE)>0)  setcookie('fyiplien','h_add_ad.php',time()+2592000,"/");
       else   $_SESSION['auth']['lien']="h_add_ad.php";   
              ...
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <ul class="nav navbar-right panel_toolbox">
                      <li><a style="color: green; font-weight: bold;" target="_blank" href="h_thumbnail_content_add.php">
                      Add preview image to video</a></li> 
                       <li><a></a></li>  
                      <li><a style="color: red; font-weight: bold;" target="_blank" href="linkhead_ad.php">
                      Add media </a></li>
