...
include '../../timee.php'; 
  if(userModel::islogged("Head of Branch")==true){ 
    ...
    if (count($_COOKIE)>0)  setcookie('fyiplien','Articles_pub.php',time()+2592000,"/");
       else   $_SESSION['auth']['lien']="Articles_pub.php";   
                ...
                <div class="x_content"> 
                    ...
                    <table id="example" class="table table-bordered" cellspacing="0" width="100%">
                      ...
                      $news = new news_publishedModel();
                        $query=$news->newsByHeadOfBranch($fyipEmail);
