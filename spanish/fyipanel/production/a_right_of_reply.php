...
'$id'");
                        ...
                        if(isset($_POST['handle_reply'])){
                            ...
                            switch ($publish_status){
                                case '1':
                                    $published = true;
                                    $mail_feedback_message = 'Derecho de respuesta ha sido publicado';
                                    break;
                                case '0':
                                    $mail_feedback_message = 'Derecho de respuesta ha sido rechazado';
                            }
                            ...
                            if($q->execute()){
                                ...
                                $mail->Subject="FYIPress Revisión del derecho de respuesta";
                                $name = $row['name'];
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                            <td style='font-size: 19px; padding: 20px;  font-family: Helvetica; line-height: 150%; text-align: right;' >
                                               ...
                                               <br> <br>
                                               para FYIPress      <br><br>
                                               Su derecho de respuesta ha sido revisado <br>
                                               ".$mail_feedback_message." 
                                                <br>
                                                ".$feedback." <br> 
                                        ...
                                        <tr>  
                                            <td style='text-align: right; padding: 20px;' >
                                                ...
                                                Todos los derechos reservados a FYIPress       
                                                </span> 
                                            </td>
                                        </tr>           
                                    </tbody> 
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    if($news_published){
                                        ?><a href="<?=$domain?>turkish/detail.php?id=<?=$news_id?>" target="_blank"><?=$row1['title']?></a><?php
                                    }
                                    else{
                                        if($reply_to_news && !$external){
                                            ?><a href="<?=$domain?>turkish/iframe.php?link=<?=$row1['link']?>&id=<?=$news_id?>" target="_blank"><?=$row1['title']?></a><?php
                                        }
