                        ...
                        // ads  
									if (adsModel::nbr_ads2()>0) {
										...
										<div class=" time2"> 
											...
											echo ads_link_comments($news['id'],$log,$linkv,'comentario','comentarios'); 
											?>
                            ...
                            <a style="color:black;" target="_blank" href="news_reply.php?news=<?= $news['id'] ?>&r=<?=$news['rank']?>">
                                Derecho de respuesta <img src="images/microphone.png">
                            </a>
                                        </span>
										</div>
									...
									foreach($req as $news){  
										...
										<article>
											...
											<div class="time2">
												...
												<?php echo $source; ?> </a> &nbsp;&nbsp;&nbsp;&nbsp;
												<?php real_news_time($news['pubDate']); 
												echo link_comments($news['id'],$log,$linkv,'comentario','comentarios',$news['rank']);
												?>
                                                <span style="padding-left: 20px; float: left; margin-right: 20px;">
                            <a style="color:black;" target="_blank" href="news_reply.php?news=<?= $news['id'] ?>&r=<?=$news['rank']?>">
                                Derecho de respuesta <img src="images/microphone.png">
						...
						<article class="col-md-12 article-list">
							<div class="inner">
								...
								<div class="details"> 
									...
									<p>
										<?php 
										$nb_words=str_word_count($news["description"]);
										$sentence=implode(' ', array_slice(explode(' ', $news["description"]), 0, 40)); 
			...
			<div class="row" > 
				...
				<div class="col-xs-12 col-sm-12 col-md-4  "   style="padding-bottom: 60px;" >  
					<?php if(news_publishedModel::rsscount2()>0||news_publishedModel::nbr_news_without_images2()>0) { 
						...
						?>
						<aside><br>
							<div class="line" style="margin: 0px 0px;"><div>Noticias</div></div>
