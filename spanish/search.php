					...
					<div class="form-group">
						<div class="input-group">
							...
							<div class="input-group-btn">
								<button type="submit" class="btn btn-primary" name="search_news" >
...
<?php if (isset($_POST['search_news'])){
    if (isset($_POST['search'])) {
		...
		if ($count == 0) {
			echo 'No hubo resultados de búsqueda.';
		}else if($searchq==""){
		echo ''; 
	    }else{ 
	    	 foreach($query as $row){ 
				...
				<div class="row">
					<article class="col-md-11" style="padding-bottom:20px;" >
						<div class="details">
						   <h6> <a href="<?php echo $linkv; ?>" target="_blank" 
						   	style="color: #000; font-weight: bold; font-size: 17px; " >
						   	 <?php echo $title; ?>
										     </a> 
										 </h6>
