                                    ...
                                    if (!in_array($file_extension, $allowed_image_extension)) {
                                        ...
                                        if (ceil($_FILES['file-3']['size'] / 1048576) > $maxsize) {
                                            ...
                                            if (move_uploaded_file($_FILES["file-3"]["tmp_name"], $target_file)) {
                                                ...
                                                echo 'Error al subir, por favor intente nuevamente';
                                            }
                                    ...
                                    ?>
                                        <div class="row" style="margin-top: 80px;">
                                            <div class="col-xs-12 text-center">
                                                <h2>Éxito</h2>
                                                <h3>La respuesta se publicará después de ser revisada</h3>
                                                <h3>Atentamente</h3>
                                                <h3>Equipo FYIPress</h3>
                                            </div>
                                        </div>
                                    <?php
                                    }
