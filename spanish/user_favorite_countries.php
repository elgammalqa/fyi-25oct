...
<script async defer data-website-id="afc1b19c-5319-4097-8747-3b05933578c7" src="https://www.fyipress.net/umami.js"></script>
    ...
    <style>
        ...
        .card [class*="card-header-"]{margin: 0 0 5px 15px;}
...
<div class="content container">
    ...
    <div class="container stats" style="display: none"><br><h1 style="text-align: right;"  >   Lista de países   </h1><hr></div>
        ...
        <form method="post" action="">
            ...
            <div class="row">
                <div class="col-xs-12 text-center">
                    <input type="submit"  name="Enregistrer" value=" Salvar ">
                </div>
            </div>
        </form>
    </div>
...
if ($log) {
    ...
    foreach ($all_user_sources as $source) {
        $topic = 'sp-' . str_replace(' ', '__', $source['country']) . '-' . str_replace(' ', '__', $source['source']);
    ...
    foreach ($selected_sources as $src) {
        ...
        $topic = 'sp-' . str_replace(' ', '__', $country) . '-' . str_replace(' ', '__', $source);
        $fcm = new WebFCMToTopic();
