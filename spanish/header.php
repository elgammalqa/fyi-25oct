...
<script async defer data-website-id="afc1b19c-5319-4097-8747-3b05933578c7" src="https://www.fyipress.net/umami.js"></script>  
	...
	@media only screen and (min-width: 991px) { 
	   ...
	   <?php } ?>
            ...
            @media only screen and (min-width: 991px) {
                #menu-lists ul.nav-list.plm > li:nth-child(2) {
                    width: 170px;
                }
            }
		</style>
				...
				<div class="container">					
					<div style="background-color: #55abcd;" id="menu-list">
						<ul id="colorblack" class="nav-list">
							...
							<li><a href="favorite_countries.php"  >fuentes favoritas</a></li>
							<?php if ($log==false) {  ?>
				...
				<div class="container">
				 ...
				 <div id="menu-lists">
						<ul class="nav-list plm"> 
                            ...
                            <li><a href="breaking_news.php?n=1">Noticias de última hora</a></li>
                            <?php
                            ...
                            ?>
							<li><a href="category.php?id=News&n=1">Noticias</a></li>
							<li><a href="category.php?id=Sports&n=1">Deportes</a></li>
                            <li><a href="category.php?id=Economy&n=1">Economía</a></li>
                            <li><a href="category.php?id=Health&n=1">Salud</a></li>
							<li><a href="category.php?id=Arts&n=1">Artes</a></li>
							<li><a href="category.php?id=Technology&n=1">Tecnología</a></li>
							<li><a href="category.php?id=Culture&n=1">Cultura</a></li>
							<li><a href="library.php?n=1">Biblioteca</a></li>
                            <li class="dropdown"><a  href="#">Países</a>
