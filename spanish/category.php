		  ...
		  <div class="container">
		    <div class="row"> 	 
								...
								<div class="row">
						          <div class="col-md-12">        
						            <ol class="breadcrumb">
						              ...
						              <li class="active">
						              	<?php echo  utilisateursModel::type($source); ?></li>
						            </ol>
						            <h1 class="page-title">categoría: 
						            	<?php echo utilisateursModel::type($source); ?></h1>
						            <p class="page-subtitle">Mostrar todos los post con la categoría <i><?php echo utilisateursModel::type($source); ?></i></p>
							          </div> 
							    </div>
							    <div class="line"></div>
							    <div class="row">
			 ...
			 <div class="col-md-4 sidebar" id="sidebar"> 
						<aside> 
							<br>
							<h1 id="ptop" class="aside-title">Noticias recientes</h1>
