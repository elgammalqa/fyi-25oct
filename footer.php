...
div.fixeddiv {
      background-image: url("logos/icons board.png"); 
      position: fixed;
      top: 300px;
      right: 5px;  
      width: 56px;
			...
			<div class="row"  >
				<div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-5" >
					...
					<ul class="list-unstyled list-inline social text-center footerCenter" style="background-color: white" > 
 						...
 						<?php
                         $sp='fyi_likes'; 
                         if (isset($_COOKIE['already_l'])){    ?>  
                         <button disabled="" class="likeButton" > 
 						<li class="list-inline-item"><a target="_blank"  >
 						<i><img src="logos/<?php echo $sp; ?>.png" class="widthHeight" ></i></a></li>
 						<li class="list-inline-item xnumber"> <?php getfooteratt($sp); ?></li></li>
 						</button> 
 					    <?php }else{ ?>
 						...
 						<li class="list-inline-item xnumber"> <?php getfooteratt($sp); ?></li>
 					    </li> 
 						</button>
 						<?php } ?>
 						</form>    
