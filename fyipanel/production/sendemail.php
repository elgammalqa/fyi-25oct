    ...
    if(userModel::isLoged_but_un_lock()){ 
      ...
      foreach($files as $file){ 
       ...
       function  emails($to,$name_user,$name_web_site,$subject,$body,$email_sender,$password_sender,$host,$port,$smtpsecure,$link){  
        $body2="<table border='0; cellspacing='0; cellpadding='0; width='80%' bgcolor='FFFFFF' style='background-color:#ffffff;padding:20px;'>
        <tbody>  
            <tr>
              <td style='font-size: 19px;  font-family: Helvetica; line-height: 150%; text-align: left;' >
               $body
          </td>
      </tr>             
        </tbody>
           ...
           action="<?php echo $_SERVER['PHP_SELF']; ?>" > 
                    <div class="form-group"> 
                      ...
                      <div class="col-md-9 col-sm-6 col-xs-12">
                        <input required type="text" placeholder="Fyi Press , Chats Run ... " name="title" id="first-name"   class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group"> 
                      ...
                      <div class="col-md-9 col-sm-6 col-xs-12">
                        <input required type="text" id="last-name" name="subject"  class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>   
                    <div class="form-group"> 
                      <label style="text-align: left" class="control-label col-md-1 col-sm-3 col-xs-12 col-md-offset-1 col-sm-offset-1" for="last-name">
                      ...
                      <div class="col-md-9 col-sm-6 col-xs-12">
                        <textarea rows="10" required name="body" class="form-control col-md-7 col-xs-12" ></textarea> 
                      </div>
                    </div>  
                     <div class="form-group"> 
