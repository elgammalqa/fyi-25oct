                    ...
                    <div class="col-md-3 left_col" style="position: fixed;">
                        <div class="left_col scroll-view">
                            <div class="navbar nav_title" style="border: 0; margin-top: 10px;margin-bottom: 10px;">
                                <a href="admin.php" class="site_title"><img style="width: 45px; height: 45px; margin-left: 5px; " class="img-circle" src="images/fyi.jpeg"><span
                                            style="margin-left: 15px;"> FYI PRESS </span></a>
                            </div>
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form enctype="multipart/form-data" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input readonly id="middle-name" value="<?php echo $user->getEmail(); ?>" class="form-control col-md-7 col-xs-12" type="Email"
                                                           name="Email">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" name="First_name" value="<?php echo $user->getFirst_name(); ?>" id="first-name" required="required"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" id="last-name" value="<?php echo $user->getLast_name(); ?>" name="Last_name" required="required"
                                                           class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" id="Phone" name="Phone" required="required" value="<?php echo $user->getPhone(); ?>" class="form-control
                                                    col-md-7
                                    col-xs-12">
                                                </div>
                                            </div>
                                    ...
                                    if (isset($_POST['save'])) {
                                        ...
                                        if (!isset($_FILES['image']) || $_FILES['image']['error'] == UPLOAD_ERR_NO_FILE) {
                                            ...
                                            if ($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg" && $imageFileType != "if") {
                                                $typeimage = 1;
                                                $uploadOk = 0;
                                            }
                                        ...
                                        $user->setPhone(strip_tags($_POST['Phone']));
                                        if ($state_logo == 1) {
                                        if ($uploadOk == 1) {
