...
'$id'");
                        ...
                        if(isset($_POST['handle_reply'])){
                            ...
                            switch ($publish_status){
                                case '1':
                                    $published = true;
                                    $mail_feedback_message = 'Right of reply has been published';
                                    break;
                                case '0':
                                    $mail_feedback_message = 'Right of reply has been rejected';
                            }
                            ...
                            if($q->execute()){
                                ...
                                $mail->Subject="FYIPress - Review of right of reply";
                                $name = $row['name'];
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                            <td style='font-size: 19px; padding: 20px;  font-family: Helvetica; line-height: 150%; text-align: right;' >
                                               ...
                                               <br> <br>
                                               to FYIPress      <br><br>
                                               Your right of reply has been reviewed <br>
                                               ".$mail_feedback_message." 
                                                <br>
                                                ".$feedback." <br> 
                                        ...
                                        <tr>  
                                            <td style='text-align: right; padding: 20px;' >
                                                ...
                                                All rights reserved to FYIPress       
                                                </span> 
                                            </td>
                                        </tr>           
                                    </tbody> 
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    if($news_published){
                                        ?><a href="<?=$domain?>detail.php?id=<?=$news_id?>" target="_blank"><?=$row1['title']?></a><?php
                                    }
                                    else{
                                        if($reply_to_news && !$external){
                                            ?><a href="<?=$domain?>iframe.php?link=<?=$row1['link']?>&id=<?=$news_id?>" target="_blank"><?=$row1['title']?></a><?php
                                        }
