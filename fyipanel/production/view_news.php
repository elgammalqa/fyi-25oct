  ...
  if(userModel::islogged("Admin")==true){ 
    if(userModel::isLoged_but_un_lock()){
      ...
      if(isset($_GET["id"])&&!empty($_GET["id"])){ 
       if (count($_COOKIE)>0)  setcookie('fyiplien',"view_news.php?id=".$_GET['id'],time()+2592000,"/");
       else   $_SESSION['auth']['lien']="view_news.php?id=".$_GET['id'];  
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <div class="container body">
      <div class="main_container"> 
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Employee : <?php echo newsModel::nameReporter($_GET["id"]); ?></h2>
                ...
                <div class="x_content">  
                    <table id="example" class="table table-bordered" cellspacing="0" width="100%">
                      ...
                      <?php   
                      $news = new newsModel();
                        $query=$news->newsSentOrWrittenByHeadOfBranch($_GET['id']);
