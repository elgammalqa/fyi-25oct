...
include '../models/v5.comments.php';     
  if(userModel::islogged("Admin")==true){ 
    ...
    if (count($_COOKIE)>0)  setcookie('fyiplien','a_ads_comments_deleted.php',time()+2592000,"/");
       else   $_SESSION['auth']['lien']="a_ads_comments_deleted.php";   
?> 
<!DOCTYPE html>
<html lang="en"> 
  <head>
<script async defer data-website-id="afc1b19c-5319-4097-8747-3b05933578c7" src="http://205.134.254.209:3000/umami.js"></script>
    ...
    <div class="container body">
      <div class="main_container"> 
        ...
        <div class="right_col" role="main"  > 
            ...
            <?php if(isset($_POST['btn_search'])&&isset($_POST['txt_search'])&&!empty($_POST['txt_search'])){ ?>
              <script type="text/javascript">
                  window.location = 'a_ads_comments_deleted.php?q=<?php echo $_POST['txt_search'];?>&n=1';
              </script> 
            <?php  } ?>
        <!--        Table              -->
        ...
        <?php if(isset($_GET['n'])&&!empty($_GET['n'])&&!isset($_GET['q'])){ // id and num page existe      
                $numpage=$_GET['n'];      
                $nbrfeeds= v5comments::temp_nbrAdsCommentsTotal();
              ...
              <?php $start=$numpage*10-10;//0
                  if ($nbrfeeds-$start>=10) {//25 
                    $req=v5comments::temp_ads_getspecialfeeds($start,10);
                    foreach($req as $news){  ?>  
                        <tr class="odd pointer">   
                            <td ><?php echo v5comments::getAdsTitle($news['id_ads']); ?></td>
                            ...
                            <input type="hidden" name="rank" value="<?php echo $news['rank']; ?>"/>
                             <td> 
                                ...
                                <button  class="flat btn btn-default">
                                  <a target="_blank" href="a_show.php?id=<?php echo $news['media']; ?>&op=adscomments">Show</a>
                                </button>  
                                <?php }else{?> 
                                <button  class="flat btn btn-default">
                                  <a target="_blank" href="a_show.php?id=<?php echo $news['media']; ?>&op=adsreplies">Show</a>
                                </button>  
                                <?php } } ?>  
                            </td>    
                          <td> 
                      <?php if($news['rank']==1){
                                 if(v5comments::check_ads_comment_exist($news['id'])){
                                ...
                                if(v5comments::check_ads_reply_exist($news['id'])){
                  ...
                  $req=v5comments::temp_ads_getspecialfeeds($start,$nbrfeeds-$start);
                  foreach($req as $news){ ?>
                        <tr class="odd pointer">
                            <td ><?php echo v5comments::getAdsTitle($news['id_ads']); ?></td>
                            <td ><?php echo v5comments::ads_title($news['id_ads']); ?></td>
                ...
                <?php  } } //else ?>
                 ...
                 <?php
                  ...
                  //before
                  if($numpage<=10){ ?>
                     <a style="display: none;" href="a_ads_comments_deleted.php?n=<?php  echo $startpage-1; ?>">
                    <button  class="btn btn-success" type="button"><</button>
                    </a> 
                  <?php }else{ ?>
                     <a href="a_ads_comments_deleted.php?n=<?php  echo $startpage-1; ?>">
                    <button  class="btn btn-success" type="button"><</button> 
                  </a>
                  <?php }  
                  ...
                  for ($i=$startpage; $i <=$endpage; $i++) { 
                    if($numpage==$i){ ?> 
                  <a href="a_ads_comments_deleted.php?n=<?php  echo $i; ?>">
                  ...
                  //next
                    if (ceil($nbrpages/10)>ceil($numpage/10)) {  ?> 
                     <a  href="a_ads_comments_deleted.php?n=<?php  echo $endpage+1; ?>">
                        <button  class="btn btn-success" type="button">></button>
                      </a>
                    <?php }else{ ?> 
                     <a style="display: none;" href="a_ads_comments_deleted.php?n=<?php  echo $endpage+1; ?>">
                      <button  class="btn btn-success" type="button">></button>
                    </a>
                      <?php } 
                      ...
                      //last page
                       if($nbrpages>10&&$numpage==$nbrpages){ ?>  
                        <a href="a_ads_comments_deleted.php?n=<?php  echo $nbrpages; ?>">
 ...
 <?php }}else if(isset($_GET['n'])&&!empty($_GET['n'])&&isset($_GET['q'])&&!empty($_GET['q'])){ //searchq 
   ...
   $q=$_GET['q'];
                ...
                $nbrfeeds=v5comments::temp_nbrAdsCommentsTotalq($q);
                $nbrpages=ceil($nbrfeeds/10); 
                if ($numpage>=1&&$numpage<=$nbrpages) {   ?>
                <div class="x_content">  
                    <div class="table-responsive">
              ...
              <?php $start=$numpage*10-10;//0
                  if ($nbrfeeds-$start>=10) {//25 
                    $req=v5comments::temp_ads_getspecialfeedsq($q,$start,10);
                    foreach($req as $news){  ?>  
                        <tr class="odd pointer">
                            <td ><?php echo v5comments::getAdsTitle($news['id_ads']); ?></td>
                            <td ><?php echo v5comments::ads_title($news['id_ads']); ?></td> 
                  ...
                  $req=v5comments::temp_ads_getspecialfeedsq($q,$start,$nbrfeeds-$start);
                  foreach($req as $news){ ?>
                        <tr class="odd pointer">
                            <td ><?php echo v5comments::getAdsTitle($news['id_ads']); ?></td>
                            <td ><?php echo v5comments::ads_title($news['id_ads']); ?></td> 
                ...
                <?php  } } //else ?>
                 ...
                 <?php
                  ...
                  //before
                  if($numpage<=10){ ?>
                     <a style="display: none;" href="a_ads_comments_deleted.php?q=<?php echo $q; ?>&n=<?php  echo $startpage-1; ?>">
                    <button  class="btn btn-success" type="button"><</button>
                    </a> 
                  <?php }else{ ?>
                     <a href="a_ads_comments_deleted.php?q=<?php echo $q; ?>&n=<?php  echo $startpage-1; ?>">
                    <button  class="btn btn-success" type="button"><</button> 
                  </a>
                  <?php }  
                  $a=floor(($numpage-1)/10)*10;
                  ...
                  for ($i=$startpage; $i <=$endpage; $i++) { 
                    if($numpage==$i){ ?> 
                  <a href="a_ads_comments_deleted.php?q=<?php echo $q; ?>&n=<?php  echo $i; ?>">
                    <button class="btn btn-info active" type="button"><?php echo $i; ?></button>
                  </a>
                  <?php }else{ ?>
                  <a href="a_ads_comments_deleted.php?q=<?php echo $q; ?>&n=<?php  echo $i; ?>">
                  ...
                  //next
                    if (ceil($nbrpages/10)>ceil($numpage/10)) {  ?> 
                     <a  href="a_ads_comments_deleted.php?q=<?php echo $q; ?>&n=<?php  echo $endpage+1; ?>">
                        <button  class="btn btn-success" type="button">></button>
                      </a>
                    <?php }else{ ?> 
                     <a style="display: none;" href="a_ads_comments_deleted.php?q=<?php echo $q; ?>&n=<?php  echo $endpage+1; ?>">
                      <button  class="btn btn-success" type="button">></button>
                    </a>
                      <?php } 
                      ...
                      //last page
                       if($nbrpages>10&&$numpage==$nbrpages){ ?>  
                        <a href="a_ads_comments_deleted.php?q=<?php echo $q; ?>&n=<?php  echo $nbrpages; ?>">
                          <button class="btn btn-warning active" type="button">
                         <?php echo $nbrpages; ?> 
                        </button></a>
                      <?php }else{ ?>
                          ...
                          function(isConfirm) { 
                              if (isConfirm) {
                                  swal({
                                      ...
                                      window.location = 'a_rep_comments.php?id=<?php echo $_POST['id_del'];?>&rank=1&op=ads'; 
                              } else {
                          ...
                          function(isConfirm) {  
                              if (isConfirm) {
                                  swal({
                                      ...
                                      timer: 1000,
                                      showConfirmButton: false }); 
                                      window.location = 'a_rep_comments.php?id=<?php echo $_POST['id_del'];?>&rank=2&op=ads'; 
                              } else {
                                  swal("Cancellation successfully", "your comment is out of risk", "info");
                              }
                          }); 
