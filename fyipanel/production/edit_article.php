  ...
  if(userModel::islogged("Head of Branch")==true){ 
    if(userModel::isLoged_but_un_lock()){
       ...
       if(isset($_GET["art"])&&!empty($_GET["art"])){
        if (count($_COOKIE)>0)  setcookie('fyiplien',"edit_article.php?art=".$_GET["art"],time()+2592000,"/");
       else   $_SESSION['auth']['lien']="edit_article.php?art=".$_GET["art"]; 
              ...
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <ul class="nav navbar-right panel_toolbox">  
                      <li><a style="color: green; font-weight: bold;" target="_blank" href="h_thumbnail_content.php">
                      Add preview image to video </a></li> 
                       <li><a></a></li>  
                    <li><a style="color: red; font-weight: bold;" target="_blank" href="linkedit.php">
                      Add media </a></li>
                            ...
                            <label class="control-label col-md-3  col-xs-12" for="first-name"> 
                              ...
                              <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                  <button href="edit_news.php" class="btn btn-primary" type="button">Cancel</button> 
      ...
      if ( $media_update_msg_error==0&&$photo_msg_error==0&&
         $thumbnail_update_msg_error==0 &&$thumbnail_msg_error==0) {
          if ($n->update_news($art)){    
             echo '<script type="text/javascript">  window.location.replace("edit_news.php"); </script>'; 
