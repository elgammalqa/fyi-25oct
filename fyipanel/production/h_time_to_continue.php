...
include '../models/news.model.php'; 
  if(userModel::islogged("Head of Branch")==true){ 
    if(userModel::isLoged_but_un_lock()){ 
        ...
        if (count($_COOKIE)>0)  setcookie('fyiplien','h_time_to_continue.php',time()+2592000,"/");
       else   $_SESSION['auth']['lien']="h_time_to_continue.php";   
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  if(isset($_POST['add_user'])){ 
                    $n=$_POST['news']; 
                      try {   $con->exec('UPDATE settings  set numberofs='.$n.' where id=2'); ?>
                      <script type="text/javascript">
                        window.location.replace('h_time_to_continue.php');
                      </script>
