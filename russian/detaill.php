                                ...
                                if($uploadOk==1){ 
                                	if (isset($_GET['r'])&&!empty($_GET['r'])) {
                                     ...
                                     <?php  }else   echo '<script>
                                                 swal("нота！"，"Комментарий не добавлен !","warning")
                                            </script> '; 
                                     ...
                                     <?php   }else   echo '<script>
                                            ...
                                            $msg=null;  
                                          if($size_error==1) $msg.='Размер файла должен быть меньше '.$maxsize.' MB\n';
                                             if($checkexistedeja==1) $msg.='Файл уже существует. Измените имя файла и повторите попытку.\n'; 
                                            if($typeimage==1) $msg.='Извините, пожалуйста, примите jpg, jpeg, png, gif, ac-3, mp3, mp4, flk, mkv, mpeg и webm форматы\n'; 
                                            if($fin==1) $msg.='Извините, произошла ошибка при загрузке файла.\n'; 
                                            $msg.="комментариев нет";  
                                            ?>
                                            <script>
                                                 swal("note!","<?php echo $msg;?>","warning")
                                            </script> 
                                        <?php 
                             }
                               }else{  
