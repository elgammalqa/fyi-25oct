		...
		<section class="single">
			<div class="container">
				<div class="row">   
					...
					?>  
						<div class="xhomeen">
							<a href="fyi.php">домашняя страница</a>
							 &nbsp; / &nbsp; подробно
						</div>
						</ol>  
						<header> 
						...
						<div class="line"><div>Вам также может понравиться</div></div>
						<div class="row">  
							<?php     
							   ...
							   <?php if ($log){?>
								...
								!commentsModel::reply_already_reported($reply['id'],$user_email)){ ?>
								   ...
								   <?php }else if(!commentsModel::HisReply($reply['id'],$user_email) && 
								     commentsModel::reply_already_reported($reply['id'],$user_email)){ ?>
								        <button disabled="" type="button" class="btn btn-danger xreporten2" data-dismiss="modal">доклад
								        </button>
								         <?php } ?> 
