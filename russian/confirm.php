		...
		<section class="category">
					<div class="container">
						...
						if (utilisateursModel:: email_non_confirmed_existe($email,$token)!=null) {  
							  ...
							  echo '<br><br><br><br> <span id="pl1" style="font-size: 30px; " >  Ваш адрес электронной почты был проверен.！</span> <br><br> <span id="pl2"style="  font-size: 30px; "> Вы можете войти в систему прямо сейчас! Нажмите <a href="login.php"> Вот </a> авторизоваться</span>'; 
								} else{
									redirect();
								}
							}
