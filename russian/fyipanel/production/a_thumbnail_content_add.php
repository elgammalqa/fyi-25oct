...
include '../models/ads.model.php'; 
  if(userModel::islogged("Admin")==true){ 
    if(userModel::isLoged_but_un_lock()){
       ...
       if (count($_COOKIE)>0)  setcookie('fyiplien',"a_thumbnail_content_add.php",time()+2592000,"/");
       else   $_SESSION['auth']['lien']="a_thumbnail_content_add.php";  
?>
<!DOCTYPE html>
<html lang="en">  
  <head>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row"> 
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Add Preview image to video  :  </h2>
                ...
                <div class="x_content">
                  ...
                  <div class="form-group"> 
                      <label style="text-align: left" class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Add Preview image to video  :  
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="file" name="media[]" runat="server"  accept="accept="image/*" required="required" id="first-name"   class="form-control col-md-7 col-xs-12" multiple="multiple" >  
                      </div>  
                       ...
                       $imageFileType != "gif"&& $imageFileType != "GIF"  ) {  $tr=false; 
                            ...
                            for($i=0;$i<count($_FILES["media"]["name"]);$i++){
                              ...
                              while($existe==true){
                                ...
                                echo '<script>
                                                 swal("Attention!","Sorry, Just Accept jpg, jpeg, png & gif   Format\n!","warning")
                                                      </script> '; 
                              }     
