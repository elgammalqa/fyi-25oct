...
include '../models/news.model.php';  
  if(userModel::islogged("Head of Branch")==true){ 
    if(userModel::isLoged_but_un_lock()){
        ...
        if (count($_COOKIE)>0)  setcookie('fyiplien','h_rss_displayed.php',time()+2592000,"/");
       else   $_SESSION['auth']['lien']="h_rss_displayed.php";   
        ...
        <div class="right_col" role="main">
         <!-- top tiles --> 
          <div class="row tile_count">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12 tile_stats_count">
              <span class="count_top"><i class="fa fa-newspaper-o"></i> 
              Number Total of news waiting </span>
              ...
              <div class="x_panel">
                ...
                <div class="x_content"> 
                  ...
                  <form action="#" enctype="multipart/form-data" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Number of rss news displayed : <span class="required">*</span></label>
                      <div class="col-md-3 col-sm-6 col-xs-12">
                  ...
                  if(isset($_POST['add_user'])){ 
                    $n=$_POST['news']; 
                      ...
                      <script type="text/javascript">
                        window.location.replace('h_rss_displayed.php');
                      </script>
