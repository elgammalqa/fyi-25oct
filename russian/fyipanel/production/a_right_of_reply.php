...
'$id'");
                        ...
                        if(isset($_POST['handle_reply'])){
                            ...
                            switch ($publish_status){
                                case '1':
                                    $published = true;
                                    $mail_feedback_message = 'Право на ответ опубликовано';
                                    break;
                                case '0':
                                    $mail_feedback_message = 'Право на ответ было отклонено';
                            }
                            ...
                            if($q->execute()){
                                ...
                                $mail->Subject="FYIPress - Обзор права на ответ";
                                $name = $row['name'];
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                            <td style='font-size: 19px; padding: 20px;  font-family: Helvetica; line-height: 150%; text-align: right;' >
                                               ...
                                               <br> <br>
                                               Pour FYIPress      <br><br>
                                               Ваше право на ответ было пересмотрено <br>
                                               ".$mail_feedback_message." 
                                                <br>
                                                ".$feedback." <br> 
