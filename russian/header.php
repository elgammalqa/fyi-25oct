	...
	@media only screen and (min-width: 991px) { 
		...
		<?php }else {  ?>
			#colorblack  li a{
				color: white;
				font-size: 15px;  letter-spacing: 2px; font-weight: 700;
                line-height: 32px;  padding-top: 16px; padding-right: 5px;
			}
	   <?php } ?>
				...
				<div class="container">					
					<div style="background-color: #55abcd;" id="menu-list">
						<ul id="colorblack" class="nav-list">  
							...
							<li><a href="favorite_countries.php"  >любимые источники</a></li>
							<?php if ($log==false) {  ?>
				 ...
				 <div id="menu-lists">
						<ul class="nav-list plm"> 
							...
							<li style="background-color: red; " class="backk" >
							 ...
							 <?php } ?>
                            <li><a href="breaking_news.php?n=1">Последние новости</a></li>
                            <?php
                            ...
                            ?>
							<li><a href="category.php?id=News&n=1">новости</a></li>
							<li><a href="category.php?id=Sports&n=1">спортивный</a></li>
                            <li><a href="category.php?id=Economy&n=1">экономика</a></li>
                            <li><a href="category.php?id=Health&n=1">Здоровье</a></li>
							<li><a href="category.php?id=Arts&n=1">искусство</a></li>
							<li><a href="category.php?id=Technology&n=1">Технология</a></li>
							<li><a href="category.php?id=Culture&n=1">культура</a></li>
							<li><a href="library.php?n=1">библиотека</a></li>
                            <li class="dropdown"><a  href="#">страны</a>
