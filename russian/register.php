						...
						<div class="box-body">
							...
							<form method="post" >
								...
								<div class="form-group">
									...
									<input placeholder="Пароль должен содержать не менее шести символов, включая (один символ или одну букву) и один номер " required="required" type="password" name="password" class="form-control">
								</div>
								<div class="form-group">
									<label class="fw">Подтвердите Пароль</label>
									<input placeholder="Пароль должен содержать не менее шести символов, включая (один символ или одну букву) и один номер " required="required" type="password" name="confirm_password" class="form-control">
								</div> 
								<div class="form-group text-right">
									<button name="register" class="btn btn-primary btn-block">регистр</button>
								</div>
								...
								<div class="form-group text-center">
									<span class="text-muted">Уже есть учетная запись?</span> <a href="login.php">Авторизоваться</a>
								</div>
							</form> 
							<?php if(isset($_POST['register'])){  
							      ...
							      ?> 
							      <script>
							          swal("Пользователь существует!","Пользователь уже существует ","warning")</script>
							     <?php
		                            ...
		                            if ($NumbresOfCaracteres<6) {
		                              $msgg='Пароль должен содержать не менее шести символов, включая (один символ или одну букву) и один номер';
		                            }else{
		                            if ($CountOfNumbers>=1) { 
		                            if ($NumbresOfCaracteres-$CountOfNumbers<=0)  {   $msgg='Пароль должен содержать не менее шести символов, включая (один символ или одну букву) и один номер';
		                             }
		                             }else {
		                                $msgg='Пароль должен содержать не менее шести символов, включая (один символ или одну букву) и один номер';
		                             }
