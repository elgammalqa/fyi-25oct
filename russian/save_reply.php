                        ...
                        if ($log && $_SERVER['REQUEST_METHOD'] == 'POST') {
                                ...
                                if (!empty($_FILES['file-3']['name'])) {
                                    ...
                                    if (!in_array($file_extension, $allowed_image_extension)) {
                                        echo 'Разрешенные расширения jpg,jpeg and png';
                                        exit;
                                    } else {
                                        $maxsize = utilisateursModel::info("maxsizecomments");
                                        if (ceil($_FILES['file-3']['size'] / 1048576) > $maxsize) {
                                            echo 'Пожалуйста, загрузите изображения в маленьком размере';
                                            exit;
                                        } else {
                                            ...
                                            if (move_uploaded_file($_FILES["file-3"]["tmp_name"], $target_file)) {
                                                ...
                                                echo 'Ошибка при загрузке! Пожалуйста, попробуйте еще раз';
                                            }
                                    ...
                                    ?>
                                        <div class="row" style="margin-top: 80px;">
                                            <div class="col-xs-12 text-center">
                                                <h2>успех</h2>
                                                <h3>Ответ будет опубликован после рассмотрения</h3>
                                                <h3>С уважением</h3>
                                                <h3>FYIPress команда</h3>
                                            </div>
                                        </div>
                                    <?php
                                    }
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 text-center">
                                                <h2>ошибка</h2>
                                                <h3>Пожалуйста, попробуйте еще раз</h3>
                                            </div>
                                        </div>
                                    <?php
                                    }
