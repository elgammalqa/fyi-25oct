...
<div class="content container">
    ...
    <div class="container stats" style="display: none"><br><h1 style="text-align: right;"  >   Список стран   </h1><hr></div>
        ...
        <form method="post" action="">
            ...
            <div class="row">
                <div class="col-xs-12 text-center">
                    <input type="submit"  name="Enregistrer" value=" Сохранить ">
                </div>
            </div>
        </form>
    </div>
...
if ($log) {
    ...
    foreach ($all_user_sources as $source) {
        $topic = 'ru-' . str_replace(' ', '__', $source['country']) . '-' . str_replace(' ', '__', $source['source']);
    ...
    foreach ($selected_sources as $src) {
        ...
        $topic = 'ru-' . str_replace(' ', '__', $country) . '-' . str_replace(' ', '__', $source);
        $fcm = new WebFCMToTopic();
