						...
						<div class="box-body">
							...
							<form method="post" >
								...
								<div class="form-group text-right">
									<button class="btn btn-primary btn-block" name="reset" >сбросить пароль</button>
								</div>
        ...
        <tbody>
          <tr>
            ...
            <tr>
              ...
              Для того, чтобы сбросить пароль ,<br>
              ...
              <td>
                    ...
                    <span style='font-size: 19px; padding: 20px;  font-family: Helvetica; line-height: 150%; text-align: left; color: #505050;' > Copyright © FYI Press, Все права защищены.  </span> 
				                ...
				                if ($mail->send()) {
				                    ...
				                    echo '<script> swal("Пароль! "," Пожалуйста, проверьте свой почтовый ящик！","success");</script>'; 
				               } else{
				                    echo '<script> swal("Пароль! "," Что случилось! пожалуйста, попробуйте снова!","warning");</script>'; 
				               }
							 	}else{
							 		 echo '<script> swal("Подписывайся! "," У вас нет подписки!","warning");</script>'; 
							 	}
							 }
