						...
						<div class="box-body">
							...
							<form method="post" > 
								...
								<div class="form-group text-right">
									<button name="change" class="btn btn-primary btn-block">менять</button>
								</div>
							</form> 
		                             ...
		                             if($tr==true){ 
							      	...
							      	$ps=password_hash($text, PASSWORD_DEFAULT); 
							           ...
							           if(isset($_COOKIE['fyiuser_pass'])){
							            ...
							            ?>
							          <script>swal("пароль！ "，"Пароль успешно изменен","success")</script> 
							         <?php }else{  ?>
					  <script>swal("Неправильный пароль！"，"Пароль отличается","warning")</script>
							         <?php 
							         }//confirm  
							     	...
							     	?>
							      <script>
						          	swal("пароль !","<?php echo $msgg; ?>","warning")
						          </script>
							  <?php   }
							          ...
							          ?>
							           <script>swal("Пароли не совпадают！"，"Текущая ошибка пароля","warning")</script>
							         <?php
							          }//current
