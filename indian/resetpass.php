					...
					<div class="box box-border">
						<div class="box-body">
							...
							<form method="post" > 
								...
								<div class="form-group">
									<label class="fw">पासवर्ड की पुष्टि कीजिये</label>
									<input required="required" type="password" name="confirm_password" class="form-control">
								</div> 
								<div class="form-group text-right">
									<button name="change" class="btn btn-primary btn-block">परिवर्तन</button>
								</div>
							</form> 
		                             ...
		                             if($tr==true){ 
							      	...
							      	$ps=password_hash($text, PASSWORD_DEFAULT); 
							           ...
							           if(isset($_COOKIE['fyiuser_pass'])){
							            ...
							            ?>
							          <script>swal("पासवर्ड! "," पासवर्ड सफलतापूर्वक बदल दिया गया है","success")</script> 
							         <?php }else{  ?>
					  <script>swal("गलत पासवर्ड! "," पासवर्ड समान नहीं हैं","warning")</script>
							         <?php 
							         }//confirm  
							  ...
							  <?php   }
							          ...
							          ?>
							           <script>swal("पासवर्ड मेल नहीं खाता! "," वर्तमान पासवर्ड गलत है","warning")</script>
							         <?php
							          }//current
