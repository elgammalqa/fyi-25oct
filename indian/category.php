		      ...
		      <div class="col-md-8 text-left">  
								<div class="row">
						          <div class="col-md-12">        
						            ...
						            <h1 class="page-title">वर्ग: <?php echo  utilisateursModel::type($source); ?></h1>
						            <p class="page-subtitle">श्रेणी के साथ सभी पोस्ट दिखा रहा है <i><?php echo utilisateursModel::type($source); ?></i></p>
							          </div> 
							    </div>
							    <div class="line"></div>
							    <div class="row">
