...
<script async defer data-website-id="afc1b19c-5319-4097-8747-3b05933578c7" src="https://www.fyipress.net/umami.js"></script>
	...
	<body class="skin-orange">
		...
		<div class="container" id="help">
			<h4 style="color: #3da0ca;">1-अपना डाउनलोड मैनेजर खोलें और विकल्पों पर जाएं</h4>
			<br>
			<img src="images/1.jpg">
			<hr>
			<h4 style="color: #3da0ca;">2- विकल्प से फ़ाइल प्रकार चुनें</h4>
			<br>
			<img src="images/2.jpg">
			<hr>
			<h4 style="color: #3da0ca;">3- चित्र में दिखाए गए फ़ाइल प्रकार (पीडीएफ) एक्सटेंशन से हटाएं और ठीक दबाएं</h4> 
			<br>
