			...
			<div class="container">
				<div class="row"> 
                  ...
                  <div class="col-md-8">
		            ...
		            <div style="padding-left: 50px; padding-right: 50px;" >
		            	 <div class="form-group">
				            <label for="sel1">रिपोर्ट का प्रकार :</label>
				              <select required="required" name="typee" class="form-control" id="sel1"> 
				                <option value="यौन सामग्री" >यौन सामग्री</option>
				                <option value="हिंसक सामग्री" >हिंसक सामग्री</option>
				                <option value="एक बुरा शब्द" >एक बुरा शब्द</option>
				                <option value="द्वेषपूर्ण भाषण" >द्वेषपूर्ण भाषण</option>
				                <option value="गाली" >गाली</option>
				              </select>
				          </div>
				          <div class="form-group">
				            <label for="pwd">अन्य :</label>
				            <textarea name="other" rows="5" cols="20" class="form-control" placeholder="अन्य ....." ></textarea> 
				         </div>
				         <div class="modal-footer">
				          <button type="submit" name="back" class="btn btn-primary" data-dismiss="modal">वापस</button>
				          <button type="submit" name="send" class="btn btn-success" data-dismiss="modal">भेजना</button>
				        </div>  
		            </div>
		            </form>
		            	<?php   
                           if (isset($_GET['id'])&&!empty( $_GET['id'])&&isset($_GET['link'])&&!empty( $_GET['link'])&&isset($_POST['back'])){ ?>
		            		<script type="text/javascript">
		                        window.location.replace("iframe.php?link=<?php echo $_GET['link']; ?>&id=<?php echo $_GET['id']; ?>");
		            		</script>
		          ...
		          <?php   }
                        ...
                        <?php  }else{ ?>  
                        	<script> 
                        	      swal("ध्यान!","रिपोर्ट नहीं गयी! आपने यह टिप्पणी पहले ही बता दी है","warning");
                            </script> 
		           		<?php }  
		           	}//id c
