								  ...
								  <?php } else if(!commentsModel::rss_HisReply($reply['id'],$user_email) && 
								   commentsModel::rss_reply_already_reported($reply['id'],$user_email)){ ?> 
 									<button disabled="" type="button"
 										 class="btn btn-danger xreporten2" data-dismiss="modal">रिपोर्ट
								     </button> 
 									<?php } ?> 
								    </div>   
								   <?php  } // log true ?>
		...
		<?php	if($log){  ?>
                        ...
                        // Check CFE $uploadOk is set to 0 by an error
                            ...
                            if($state_logo==1){  
                            	if($uploadOk==1){ 
                            		if (isset($_GET['r'])&&!empty($_GET['r'])) {
                            			...
                            			<?php  }else { ?>
                            				<script> 
                            					swal("ध्यान!"," टिप्पणी नहीं जोड़ा गया है !","warning"); 
                            				</script>
                            				<?php 	}  
                            		}
                            		/*
                            			...
                            			if ($comment->rss_add_comments()==true){ ?>   
                            				<script>
                            				 ...
                            				 <?php   }else{  ?>
                                     	    <script>
                                                 swal("Attention!"," टिप्पणी नहीं जोड़ा गया है !","warning")
                                            </script> '; 
                                     <?php   }
                                		  }
                                		  */
                            ...
                            if($size_error==1) $msg.='फ़ाइल का आकार कम होना चाहिए '.$maxsize .' MB\n'; 
                                            ...
                                            ?>
                                            <script>
                                                 swal("ध्यान!","<?php echo $msg;?>","warning")
                                            </script> 
                            			<?php 
                            		}
                            	}else{  
