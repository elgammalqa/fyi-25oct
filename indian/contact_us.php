...
<script async defer data-website-id="afc1b19c-5319-4097-8747-3b05933578c7" src="http://205.134.254.209:3000/umami.js"></script> 
	...
	<body  class="skin-orange" onLoad="document.myf.name.focus();">
		...
		<section class="category" style="margin-bottom: 2%" >
			<div class="container"> 
			<h3 class="fcontact" >हमसे संपर्क करें</h3>
			<form method="post" name="myf"  id="myf"  >
				<div class="row" >
					<div class="col-md-8 col-xs-12 col-sm-12"> 
	                    <label for="fullname">नाम * : </label> 
	                    <?php if($log){ ?>
				...
				<div class="row" >
					<div class="col-md-8 col-xs-12 col-sm-12"> 
	                    <label for="fullname">ई-मेल * : </label>
	                    <?php if($log){ ?>
				...
				<div class="row" >
					<div class="col-md-8 col-xs-12 col-sm-12"> 
	                    <label for="fullname">फ़ोन : </label>
	                    <input class="form-control" name="phone" />
                	</div>  
				</div> 
				<div class="row" >
					<div class="col-md-8 col-xs-12 col-sm-12"> 
	                    <label for="fullname">विषय * : </label>
	                    <input required class="form-control" name="subject" />
                	</div>
				</div> 
				<div class="row" >
					<div class="col-md-8 col-xs-12 col-sm-12"> 
	                    <label for="fullname">संदेश * : </label>
    	...
    	if(nb_messages_today($email)>1){ 
    		echo '<script>swal("संदेश","आप प्रति दिन 2 से अधिक संदेश नहीं जोड़ सकते हैं", "warning");</script>';  
    	}else{  
    		if(add_message($email,$name,$subject,$message,$phone)){
    		echo '<script>swal("संदेश","संदेश सफलतापूर्वक भेजा गया", "success");</script>';
    		}else{
    		echo '<script>swal("संदेश","संदेश सफलतापूर्वक नहीं भेजा गया था", "warning");</script>'; 
    		}
    	} 
   		 }else{//recap not ok
   		 	echo '<script>swal("रोबोट","जांचें कि मैं रोबोट नहीं हूं", "warning");</script>';
   		 }
	    }else{//not checked 
	      echo '<script>swal("रोबोट","जांचें कि मैं रोबोट नहीं हूं", "warning");</script>';
	    }  
