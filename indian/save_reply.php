                                    ...
                                    if (!in_array($file_extension, $allowed_image_extension)) {
                                        ...
                                        if (ceil($_FILES['file-3']['size'] / 1048576) > $maxsize) {
                                            ...
                                            if (move_uploaded_file($_FILES["file-3"]["tmp_name"], $target_file)) {
                                                ...
                                                echo 'अपलोड करने में त्रुटि हुई! कृपया पुन: प्रयास करें';
                                            }
                                    ...
                                    ?>
                                        <div class="row" style="margin-top: 80px;">
                                            <div class="col-xs-12 text-center">
                                                <h2>सफलता</h2>
                                                <h3>समीक्षा के बाद जवाब प्रकाशित किया जाएगा</h3>
                                                <h3>सादर</h3>
                                                <h3>FYIPress की टीम</h3>
                                            </div>
                                        </div>
                                    <?php
                                    }
