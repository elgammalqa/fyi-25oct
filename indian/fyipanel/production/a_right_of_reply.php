...
'$id'");
                        ...
                        if(isset($_POST['handle_reply'])){
                            ...
                            switch ($publish_status){
                                case '1':
                                    $published = true;
                                    $mail_feedback_message = 'उत्तर का अधिकार प्रकाशित किया गया है';
                                    break;
                                case '0':
                                    $mail_feedback_message = 'उत्तर का अधिकार अस्वीकार कर दिया गया है';
                            }
                            ...
                            if($q->execute()){
                                ...
                                $mail->Subject="FYIPress- उत्तर के अधिकार की समीक्षा";
                                $name = $row['name'];
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                            <td style='font-size: 19px; padding: 20px;  font-family: Helvetica; line-height: 150%; text-align: right;' >
                                               ...
                                               <br> <br>
                                               सेवा FYIPress      <br><br>
                                               आपके उत्तर के अधिकार की समीक्षा की गई है
 <br>
                                               ".$mail_feedback_message." 
                                                <br>
                                                ".$feedback." <br> 
                                        ...
                                        <tr>  
                                            <td style='text-align: right; padding: 20px;' >
                                                ...
                                                सभी अधिकार FYIPress के लिए आरक्षित हैं       
                                                </span> 
                                            </td>
                                        </tr>           
                                    </tbody> 
