				...
				<div class="container">					
					<div style="background-color: #55abcd;" id="menu-list">
						<ul id="colorblack" class="nav-list">  
							...
							<li><a href="favorite_countries.php"  >पसंदीदा स्रोत</a></li>
							<?php if ($log==false) {  ?>
			...
			<div class="container">
				 ...
				 <div id="menu-lists">
						<ul class="nav-list plm"> 
                            ...
                            <li><a href="breaking_news.php?n=1">ताज़ा खबर</a></li>
                            <?php
                            ...
                            ?>
							<li><a href="category.php?id=News&n=1">समाचार</a></li>
							<li><a href="category.php?id=Sports&n=1">खेल</a></li>
                            <li><a href="category.php?id=Economy&n=1">अर्थव्यवस्था</a></li>
                            <li><a href="category.php?id=Health&n=1">स्वास्थ्य</a></li>
							<li><a href="category.php?id=Arts&n=1">कला</a></li>
							<li><a href="category.php?id=Technology&n=1">प्रौद्योगिकी</a></li>
							<li><a href="category.php?id=Culture&n=1">संस्कृति</a></li>
							<li><a href="library.php?n=1">पुस्तकालय</a></li>
                            <li class="dropdown"><a  href="#">देश</a>
