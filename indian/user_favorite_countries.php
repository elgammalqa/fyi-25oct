...
<div class="content container">
    ...
    <div class="container stats" style="display: none"><br><h1 style="text-align: right;"  >   Countries list   </h1><hr></div>
...
if ($log) {
    ...
    foreach ($all_user_sources as $source) {
        $topic = 'in-' . str_replace(' ', '__', $source['country']) . '-' . str_replace(' ', '__', $source['source']);
    ...
    foreach ($selected_sources as $src) {
        ...
        $topic = 'in-' . str_replace(' ', '__', $country) . '-' . str_replace(' ', '__', $source);
        $fcm = new WebFCMToTopic();
