		...
		<section class="category">
					<div class="container">
						...
						if (utilisateursModel:: email_non_confirmed_existe($email,$token)!=null) {  
							  ...
							  echo '<br><br><br><br> <span id="pl1" style="font-size: 30px; " > आपका ईमेल सत्यापित किया गया है!</span> <br><br> <span id="pl2"style="  font-size: 30px; "> अब आप लॉग इन कर सकते हैं! Click <a href="login.php"> here </a> लॉग इन करने के लिए</span>'; 
								} else{
									redirect();
								}
							}
