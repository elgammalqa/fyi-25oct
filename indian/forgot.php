						...
						<div class="box-body">
							...
							<form method="post" >
								...
								<div class="form-group text-right">
									<button class="btn btn-primary btn-block" name="reset" >पासवर्ड रीसेट</button>
								</div>
								<div class="form-group text-center">
									<span class="text-muted">लॉगिन पर वापस जाएं?</span> <a href="login.php">लॉग इन करें</a>
								</div> 
							</form>
							<?php 
        ...
        <tbody>
          <tr>
            ...
            <tr>
              ...
              अपना पासवर्ड रीसेट करने के लिए ,<br>
