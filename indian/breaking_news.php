              ...
              <div class="row">
                  <div class="col-md-12">
                      <ol class="breadcrumb">
                          ...
                          <li class="active">ताज़ा खबर</li>
                      </ol>
                      <h1 class="page-title">ताज़ा खबर</h1>
                              ...
                              <div class="details  ">
                                        ...
                                        <div class="detail" style="float: left;">
                                            ...
                                            <div class="time right_of_reply">
                                                <span class=" ">
                                                    <a class="right_of_reply_news_link" href="news_reply.php?news=<?=$news['id']?>&r=2">उत्तर का अधिकार <img src="images/microphone.png" alt=""></a>
                                                </span>
                                            </div>
            ...
            <div class="inner">
              ...
              <div class="details  ">
                        ...
                        <div class="detail" style="float: left;">
                            ...
                            <div class="time right_of_reply">
                                <span class=" ">
                                    <a class="right_of_reply_news_link" href="news_reply.php?news=<?=$news['id']?>&r=<?=$news['rank']?>">उत्तर का अधिकार <img
        ...
        <div class="col-md-12 text-center  " style="padding-bottom: 30px;">
            ...
            <?php if(news_publishedModel::nbrhotnews()>0){  ?>
                <div class="col-md-4 sidebar" id="sidebar">
                    <aside>
                        <br>
                        <h1 id="ptop" class="aside-title">नवीनतम समाचार</h1>
                                        ...
                                        <div class="details">
                                            ...
                                            <div class="detail " style="padding-top: 10px;" >
                                                ...
                                                <div style="margin-left: 10px; float: left;  "><a class="right_of_reply_news_link"
                                                                                                  target="_blank" href="news_reply.php?news=<?=$news['id']?>" >उत्तर का अधिकार<img src="images/microphone.png" alt="Microphone"></a></div>
                                            </div>
                                        </div>
                                    </div>
                                </article>
