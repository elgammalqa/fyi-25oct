					...
					<div class="box box-border">
						<div class="box-body">
							...
							<form method="post" >
								...
								<div class="form-group"> 
									<label class="fw">पारण शब्द 
									</label>
									<input  placeholder="Enter Your Password" required="required" type="password" name="password" class="form-control">
									<a href="forgot.php" class="pull-right">पासवर्ड भूल गए?</a>
									<!-- href="forgot.php" -->
								</div>
								<br>
								<div class="form-group text-right">
									<button name="login" class="btn btn-primary btn-block">लॉग इन करें</button>
								</div>
								<div class="form-group text-center">
									<span class="text-muted">खाता नहीं है?</span> <a href="register.php">एक बनाए</a> <br>
									<span class="text-muted">आपको अपना सत्यापन लिंक प्राप्त नहीं हुआ है: <br>
									</span> <a href="link_verification.php">उसे दोबारा भेजो</a>
								</div>  
							</form>  
                            ...
                            ?>
                              ...
                              $_SESSION['user_auth']=array('user_pass'=>$user->getpassword(),'user_email'=>$logg);    $user->active_status($logg); ?>
                                  <script> window.location.replace('home.php'); </script><?php
	                      	 	...
	                      	 	echo '<script> swal("पहुंच अस्वीकृत!","कृपया अपना ईमेल जांचें - हमने एक पुष्टिकरण संदेश भेजा है या इसे फिर से भेजें पर क्लिक करें","warning");</script>';
	                      	 }  

                    }else{ ?>
                      <script> swal("पहुंच अस्वीकृत!","ईमेल या पासवर्ड गलत है !! पुन: प्रयास करें","warning");</script>
             <?php  }
            }else{ ?>
                  <script> swal("पहुंच अस्वीकृत!","ईमेल या पासवर्ड गलत है !! पुन: प्रयास करें","warning");</script>
      <?php }  
