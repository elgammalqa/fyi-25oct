				            ...
				            <div class="inner">
				              ...
				              <div class="details mar_right"> 
				    					...
				    					<div class="detail" style="float: right;">
                                            ...
                                            <div style="margin-right: 25px; float: left; font-size: 17px; direction: rtl;"><a class="right_of_reply_news_link" target="_blank" href="news_reply.php?news=<?=$news['id']?>&r=<?=$news['rank']?>" >זכות תשובה<img src="images/microphone.png" alt=""></a></div>
				    					</div> 
				    				</div>  
				            </div>
				          </article>
