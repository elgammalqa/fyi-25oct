			...
			<div class="container">
			 ...
			 <div class="col-md-4 sidebar" id="sidebar" style="margin-top: 15px;"> 
					  <?php if(news_publishedModel::nbrhotnews()>0){  ?> 
						<aside> 
							<br>
							<h5 class=" float_right" style="font-family: 'Droid Arabic Kufi', serif; letter-spacing: 0px; margin-bottom: 0px;"  >  חדשות אחרונות  </h5> 
                  ...
                  <div class="col-md-8">
		            ...
		            <div style="padding-left: 50px; padding-right: 50px;" >
		            	 <div class="form-group">
				            <label for="sel1" class="myfont" > סוג דוח  </label>
				              <select required="required" name="typee" class="form-control" id="sel1" 
				              class="myfont2" style="font-size: 20px;"> 
				                <option value="Sexual content" >תוכן מיני  </option>
				                <option value="Violent content" > תוכן אלים  </option>
				                <option value="A bad words" > מילים רעות  </option>
				                <option value="Hate speech" > דברי שנאה  </option>
				                <option value="Abuse" > התעללות  </option>
				              </select>
				          </div>
				          <div class="form-group">
				            <label for="pwd" class="myfont">אחר</label>
		          ...
		          <?php   }
                        ...
                        <?php  }else{ ?> 
                        	<script> 
                        	      swal("تحذير!","لم يتم إضافة البلاغ ! لقد ابلغت عن هذا التعليق من قبل ","warning");
                            </script> 
		           		<?php }  
		           	}//id c
