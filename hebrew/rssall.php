		    ...
		    <div class="row"> 
		    	 <div class="col-md-4 sidebar" id="sidebar"  > 
					  <?php if(news_publishedModel::nbrhotnews()>0){  ?> 
						<aside> 
							<br>
							<h1 class="aside-title float_right" style="margin-bottom: 0px;"  >חדשות אחרונות</h1> 
							    <div class="line"  ></div>
		            ...
		            <div class="col-md-8 float_right "> 
		      	            <div  >
					 	        <ol   style="list-style: none; " >
						            <li class="float_right fs_cat "  ><a href="index.php">בית</a>
						              </li>
						            <li class="float_right fs_cat">  &nbsp; / &nbsp;</li> 
						            <li class="float_right fs_cat" class="active"> חדשות  </li>
                                </ol> 
                                <br><br>
					        </div>
