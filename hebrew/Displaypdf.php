...
<script async defer data-website-id="afc1b19c-5319-4097-8747-3b05933578c7" src="http://205.134.254.209:3000/umami.js"></script>
	...
	<body class="skin-orange">
		...
		<div class="container" id="help">
			<h4 style="color: #3da0ca;">1- פתח את ההורדה מאנגר וללכת אפשרויות</h4>
			<br>
			<img src="images/1.jpg">
			<hr>
			<h4 style="color: #3da0ca;">2- מתוך אפשרויות בחר סוגי קבצים</h4>
			<br>
			<img src="images/2.jpg">
			<hr>
			<h4 style="color: #3da0ca;">3- מתוך סוגי קבצים מחק (PDF) הרחבה כפי שמוצג בתמונה ולחץ על אישור</h4> 
			<br>
