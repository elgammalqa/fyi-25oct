			...
			<div class="container">
			 ...
			 <div class="col-md-4 sidebar" id="sidebar" style="margin-top: 15px;"> 
							...
							<article class="article-fw" style="padding-bottom: 40px;" >
								<div class="inner">
									...
									<div class="details">
										...
										<div class="detail"   > 
										 	<a class=" xtype">  
									          <?php echo utilisateursModel::source($typesection4); ?> 
									      	</a> 
										  	<span class="xdate" >
					...
					<?php if(news_publishedModel::nbrnewsStartCountVideos2()>0){ ?> 
						<div class="line"><div> סרטונים </div></div> 
						<div class="row">  
							 <?php  	// news videos    
					 	$news=new news_publishedModel();   
									$query=$news->newsStartCountVideos2(2);
                        			foreach($query as $news){  
                        			 if($news['rank']==1){ 
						...
						<article class="article-fw " > 
								<div class="inner" > 
									...
									<div class="details" style="background-color: white">
										...
										<div class="detail  "   >
											<a class="xtype">  
									          <?php echo utilisateursModel::source($typesectionv); ?> </a>
										  	<span class="xdate" >
												<?php real_news_time($news['pubDate']); ?>  
										   </span>
										</div>
						    ...
						    <?php if ($log==true){?>
							    ...
							    <a href="<?php echo 'detaill.php?id='.$id_art_actuel.'&r='.$comment['id']; ?>">
								   <button  type="button" class="btn btn-primary xreply" data-dismiss="modal">
								    ...
								    <button type="button" class="btn btn-danger xreport1" data-dismiss="modal"> להגיש תלונה 
								    </button>
								    </a>
					    ...
					    <?php	$qrss=repliesModel::repliesStartNbres(0,10,$id_art_actuel,$comment['id']);
					        foreach ($qrss as $reply) {    ?> 
							   ...
							   <?php if ($log==true){?>
								    <div style="border: none;" class="modal-footer">
								    <a href="<?php echo 'detaill.php?id='.$id_art_actuel.'&r='.$comment['id']; ?>">
								        <button  type="button" class="btn btn-primary xreply" data-dismiss="modal"> תשובה  
								        </button>
								   	</a>
								        ...
								        <a href="<?php echo 'report.php?id='.$id_art_actuel.'&id_r='.$reply['id']; ?>">
								        	<button  type="button" class="btn btn-danger xreport1"  
								        		data-dismiss="modal"> להגיש תלונה 
								        	</button>
								        </a>
