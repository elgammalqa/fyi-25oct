...
include '../models/news_published.model.php'; 
  if(userModel::islogged("Head of Branch")==true){ 
    if(userModel::isLoged_but_un_lock()){
       ...
       if (count($_COOKIE)>0)  setcookie('fyiplien','h_dnp.php',time()+2592000,"/");
       else   $_SESSION['auth']['lien']="h_dnp.php";   
?>
<!DOCTYPE html>
<html lang="en">
  <head>
                    ...
                    <table id="example" class="table table-bordered" cellspacing="0" width="100%">
                            <thead>
                              <tr class="headings">   
                                ...
                                <th >Type </th>
                                <th >pubDate </th>
                                <th >Admin / Head / Reporter</th> 
                                <th >Delete </th>
                              </tr>
                            </thead> 
                             <tbody>
                      <?php  $news = new news_publishedModel(); $query=$news->all_news_published();
            ...
            swal({
                ...
                function(isConfirm) {
                    if (isConfirm) {
                        ...
                        window.location = 'delete_article_published.php?id_del=<?php echo $_POST['id_del'];?>';
                    } else {
