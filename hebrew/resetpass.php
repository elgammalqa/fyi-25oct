		                             ...
		                             if($tr==true){ 
							      	...
							      	$ps=password_hash($text, PASSWORD_DEFAULT); 
							           ...
							           if(isset($_COOKIE['fyiuser_pass'])){
							            ...
							            ?>
							          <script>swal("סיסמה! "," הסיסמה שונתה בהצלחה","success")</script> 
							         <?php }else{  ?>
					  <script>swal("סיסמא שגויה! "," סיסמאות אינן זהות","warning")</script>
							         <?php 
							         }//confirm  
							     }else{// 5 numbers and 1 letter 
							     	  $msgg='על הסיסמה לכלול לפחות שישה תווים, כולל תו אחד או אות אחת ומספר אחד';
							     	?>
							      <script>
							  ...
							  <?php   }
							          ...
							          ?>
							           <script>swal("הסיסמה אינה תואמת! "," הסיסמה הנוכחית שגויה","warning")</script>
							         <?php
							          }//current
