...
<body> 
    <div class="content container">
        ...
        <div class="container stats"><br><h1 style="text-align: right;"   >רשימת הארצות    </h1><hr></div>
        <div class="container-fluid">
         ...
         foreach($req as $country){ 
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
              <div class="card card-stats">
                ...
                <div class="card-footer">
                  <div class="stats">  
             <label class="containers">  לעקוב אחר   
             <?php   
              if($log==true){//logged 
             ...
             <?php } 
              ...
              if(isset($_COOKIE['hebrew_sources'])){ //there is a cookie
          ...
          <?php }  //for  ?> 
             ...
             <input type="submit" class="green" name="Enregistrer" value="  לשמור   " style="font-size: 26px; margin-right: 60px; " > 
            </form> 
          </div>   
        </div>   
            <?php  
         ...
         $GLOBALS['nb_sources_not_checked']+=v4Utilisteurs::nb_rss_sources_of_country($country['country']);
              ...
              if($GLOBALS['nb_sources_not_checked']>=5){//ok we can continue
                  ...
                  if($log==false){
                      if(isset($_COOKIE['hebrew_sources'])){
                      setcookie('hebrew_sources', json_encode($data),time()+31556926 ,'/');
                    }else{
                      setcookie('hebrew_sources', json_encode($notchecked),time()+31556926 ,'/'); 
                    }
                  }
                  ?>
                ...
                echo "<script> alert(' אתה חייב לעקוב לפחות חמישה מקורות   '); </script>";
              }  
