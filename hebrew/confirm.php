		...
		<section class="category">
					<div class="container">
						...
						if (utilisateursModel:: email_non_confirmed_existe($email,$token)!=null) {  
							  ...
							  echo '<br><br><br><br> <span id="pl1" style="font-size: 30px; " >  כתובת הדוא"ל שלך אומתה!</span> <br><br> <span id="pl2"style="  font-size: 30px; "> אתה יכול להתחבר עכשיו! לחץ על <a href="login.php"> here </a> to login</span>'; 
								} else{
									redirect();
								}
							}
