									...
									<div class="details">
										...
										<div class="detail float_right " style="padding-top: 10px;" >
                                            ...
                                            <div style="margin-right: 25px; float: left; font-size: 17px; direction: rtl;"><a class="right_of_reply_news_link" target="_blank"
                                                                                                                              href="news_reply.php?news=<?=$news['id']?>" >זכות תשובה<img src="../images/microphone.png"
                                                            alt=""></a></div>
										</div>
									</div>
								</div>
                ...
                <div class="row">
                  <div class="col-md-12 float_right">
                    <ol   style="list-style: none; " >
                      ...
                      <li class="float_right fs_cat" class="active">השב זכויות<?php //echo utilisateursModel::type($source); ?></li>
                     </ol>
                 </div>
                </div>
                <div class="line"></div>
                              ...
                              <div class="details mar_right">
                                        ...
                                        <div class="detail" style="float: right;">
                                            ...
                                            <div class="time right_of_reply">
                                                <span class="float_rightd">
                                                    <a class="right_of_reply_news_link" href="news_reply.php?news=<?=$news['id']?>">זכות תשובה<img src="../images/microphone.png" alt=""></a>
                                                </span>
                                            </div>
