						...
						<div class="box-body">
							...
							<form method="post" >
								...
								<div class="form-group text-right">
									<button class="btn btn-primary btn-block" name="reset" >איפוס הסיסמה</button>
								</div>
								<div class="form-group text-center">
									<span class="text-muted">חזרה להתחברות?</span> <a href="login.php">התחברות</a>
								</div> 
							</form>
							<?php 
          ...
          <span style='float:right;' >
             &nbsp;&nbsp;&nbsp;  ברוך הבא ל
              ...
              FYI PRESS
                 ...
                 <br><br>
              כדי לאפס את הסיסמה אנא לחץ על הקישור להלן  
                <br> <br> 
            ...
            <tr>  
              <td>
                    ...
                    <span style='font-size: 19px; padding: 20px;  font-family: Helvetica; line-height: 150%; text-align: right; float: right; color: #505050;' >Copyright © FYI Press, כל הזכויות שמורות.  </span> 
                </td>
            </tr>
				                ...
				                if ($mail->send()) {
				                    ...
				                    echo '<script> swal("סיסמה! "," אנא בדוק את תיבת הדואר הנכנס שלך!","success");</script>'; 
				               } else{
				                    echo '<script> swal("סיסמה !"," משהו השתבש! בבקשה נסה שוב !","warning");</script>'; 
				               }
							 	}else{
							 		 echo '<script> swal("מנוי! "," אינך מנוי!","warning");</script>'; 
							 	}
							 }
