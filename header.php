	...
	@media only screen and (min-width: 991px) { 
		...
		<?php }else {  ?> 
			#colorblack  li a{
				color: white;
				font-size: 15px;  letter-spacing: 2px; font-weight: 700;
                line-height: 32px;  padding-top: 16px; padding-right: 15px;
			} 
	   <?php } ?>
					...
					<div style="background-color: #55abcd;" id="menu-list">
						...
						if(isMobile()){ ?>
							<li style="background-color: red;  " class="backk" ><a 
								style="  font-size: 30px; color:#fff; border-bottom: none !important; ">Back <i style="text-align: left; font-size: 30px;" class="ion-ios-arrow-forward"></i></a></li> 
							 <?php }else{ ?>  
							<li><a id="logocolor" href="home.php" style="padding-left:20px !important;"><img src="images/fyipress.png" 
							style="width: 50px; height: 30px;" ></a></li>
							<li><a id="logocolor" href="fyi.php" style="padding-left:20px !important;"><img src="images/fyipress2.png" 
							style="width: 50px; height: 30px;" ></a></li>
						<?php } ?>   


							<li  ><a target="_blank" href="https://www.chatsrun.com"  >ChatsRun</a></li>
							<li><a target="_blank" href="https://www.ispotlights.com"  >SpotLights</a></li>
							<li><a href="favorite_countries.php"  >Favorite Sources</a></li>
							<?php if ($log==false) {  ?>
							 ...
							 <ul id="colorblack2" class="dropdown-menu">  
									<li>
										<a href="resetpass.php">
										    <i  class="icon ion-key">  </i>Change Password 
									    </a>
									</li> 
									<li class="divider"></li>
					  ...
					  if(!isMobile()){ ?>
						    	<li  class="dropdown magz-dropdown">
										...
										<a style="  padding-left:50px;">Languages <i class="ion-ios-arrow-right"></i></a>
										<ul id="colorblack2" class="dropdown-menu">
							   ...
							   <?php } ?> 
							<li  class="font"  >
								<a target="_blank"  href="search.php"
								 style="padding-right: 0px;" >
								    <i style="font-size: 17pt; " class="ion-search"> </i>
							    </a>
							</li>
				...
				<div class="container">  
					...
					<div class="mobile-toggle">
					 ...
					 <div style="float: left;" class="mobile-toggle">
						<a href="home.php" ><img style="width: 50px; height: 30px;" src="images/fyipress.png"></a>
					</div>
					<!-- v5 -->
					 <div style="float: left;" class="mobile-toggle">
				    ...
				    <div id="menu-lists">
					 ...
					 <?php if(isMobile()){ ?>
							<li style="background-color: red; " class="backk" >
								<a style="  font-size: 30px; color:#fff; border-bottom: none !important; ">Back <i style="text-align: left; font-size: 30px;" class="ion-ios-arrow-forward"></i></a></li>
							 <?php } ?>
							<li><a href="home.php">Home</a></li>
                            <li><a href="breaking_news.php?n=1">Breaking news</a></li>
                            <?php
                            ...
                            ?>
                            <li><a href="category.php?id=News&n=1">News</a></li>
							<li><a href="category.php?id=Sports&n=1">Sports</a></li>
                            <li><a href="category.php?id=Economy&n=1">Economy</a></li>
                            <li><a href="category.php?id=Health&n=1">Health</a></li>
                            <li><a href="category.php?id=Arts&n=1">Arts</a></li>
							<li><a href="category.php?id=Technology&n=1">Technology</a></li>
							<li><a href="category.php?id=Culture&n=1">Culture</a></li>
							<li><a href="library.php?n=1">Library</a></li>
