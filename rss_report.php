			...
			<div class="container">
				<div class="row"> 
                  ...
                  <div class="col-md-8">
		            ...
		            <div style="padding-left: 50px; padding-right: 50px;" >
		            	 <div class="form-group">
				            <label for="sel1">Type Of Report :</label>
				              <select required="required" name="typee" class="form-control" id="sel1"> 
				                ...
				                <option value="A bad words" >A bad words</option>
				          ...
				          <div class="form-group">
				            ...
				            <textarea name="other" rows="5" cols="20" class="form-control" placeholder="Other ....." ></textarea> 
				         </div> 
				         <div class="modal-footer">
				          <button type="submit" name="back" class="btn btn-primary" data-dismiss="modal">Back</button>
				          <button type="submit" name="send" class="btn btn-success" data-dismiss="modal">Send</button>
				        </div>  
		            </div>
		            </form>
		            	<?php   
		          ...
		          <?php   }
                        ...
                        <?php  }else{ ?> 
                        	<script> 
                        	      swal("Attention!","Report does not added ! You have already reported this comment","warning");
                            </script> 
		           		<?php }  
		           	}//id c
