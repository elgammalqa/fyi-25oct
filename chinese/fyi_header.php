	...
	@media only screen and (min-width: 991px) { 
		<?php if ($log==false) {  ?>
			#colorblack  li a{
                ...
                line-height: 32px;  padding-top: 16px; padding-right: 65px;
			}
		<?php }else {  ?>
			#colorblack  li a{
				color: white;
				font-size: 15px;  letter-spacing: 2px; font-weight: 700;
                line-height: 32px;  padding-top: 16px; padding-right: 60px;
			}
	   <?php } ?>
					...
					<div style="background-color: #55abcd;" id="menu-list">
						<ul id="colorblack" class="nav-list">  
							...
							<li style="background-color: red; " class="backk" ><a 
								style="  font-size: 30px; color:#fff; border-bottom: none !important; ">背部 <i style="text-align: left; font-size: 30px;" 
							...
							<!--
							<li><a target="_blank" href="favorite_countries.php"  >最喜欢的来源</a></li>
 							-->
							<?php if ($log==false) {  ?>
							 ...
							 <ul id="colorblack2" class="dropdown-menu">  
									<li>
										<a href="resetpass.php">
										    <i  class="icon ion-key">  </i>更改密码 
									    </a>
									</li> 
									<li class="divider"></li>
									<li><a href="logout.php">
										<i class="icon ion-log-out"></i> 注销</a></li>
								</ul>
						    </li> 
						<?php }  
						 if(!isMobile()){ ?>
							<li  class="dropdown magz-dropdown">
										<a style="  padding-left:50px;">语言 <i class="ion-ios-arrow-right"></i></a>
										<ul id="colorblack2" class="dropdown-menu">
				 ...
				 <div id="menu-lists">
					 ...
					 <li style="background-color: red; " class="backk" >
						 <a style="  font-size: 30px; color:#fff; border-bottom: none !important; ">
						 	背部 <i style="text-align: left; font-size: 30px;" class="ion-ios-arrow-forward"></i></a></li>
							 <?php } ?>
							<li><a href="fyi.php">主页</a></li>
							<li><a href="fyi_category.php?id=News&n=1">新闻</a></li>
							<li><a href="fyi_category.php?id=Sports&n=1">体育</a></li>
							<li><a href="fyi_category.php?id=Arts&n=1">艺术</a></li>
							<li><a href="fyi_category.php?id=Technology&n=1">科技</a></li>
							<li><a href="fyi_category.php?id=Culture&n=1">一般文化</a></li> 
							<li><a href="fyi_library.php?n=1">图书馆</a></li>  
						</ul>
					</div>
                   ...
                   <div id="menu-lang">
						<ul class="nav-list plm">  
							<li style="background-color: red; " class="backk" >
								<a style="  font-size: 30px; color:#fff; border-bottom: none !important; ">	背部 <i style="text-align: left; font-size: 30px;" class="ion-ios-arrow-forward"></i></a></li>
									<li><a class="pl" href="../arabic/index.php"  >العربية</a></li>
											<li><a class="pl" href="../urdu/index.php" >ارڈو </a></li>
											<li><a class="pl" href="../home.php" >English</a></li> 
											<li><a class="pl"  href="../turkish/index.php" >Türkçe</a></li>
