						...
						<?php	if($log){  ?>
							<form style="padding-bottom: 50px;"  enctype="multipart/form-data" method="post" class="row"> 
								<div class="form-group col-md-12">
									...
									<textarea style="font-size: 18px;" maxlength="500" required="required" id="myTextField"  class="form-control" name="message"  placeholder="写下你的评论 ..."></textarea>
								</div>  
								...
								<div class="form-group col-md-4"> 
									...
									<input value="发表评论" name="send" type="submit" class="btn btn-primary form-control" style="font-size: 20px; padding-top:5px !important; margin-top: 0px !important">
								</div>  
							</form>
                                	...
                                	if (isset($_GET['r'])&&!empty($_GET['r'])) {
                                     ...
                                     <?php }else   echo '<script>
                                            ...
                                            $msg=null;  
                                             ...
                                             if($checkexistedeja==1) $msg.='文件已经存在, 请更改文件名并重试\n'; 
