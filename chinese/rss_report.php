			...
			<div class="container">
				<div class="row"> 
                  ...
                  <div class="col-md-8">
		            ...
		            <div style="padding-left: 50px; padding-right: 50px;" >
		            	 <div class="form-group">
				            <label for="sel1">报告类型 :</label>
				              <select required="required" name="typee" class="form-control" id="sel1"> 
				                <option value="性内容" >性内容</option>
				                <option value="暴力内容t" >暴力内容</option>
				                <option value="一个坏话" >一个坏话</option>
				                <option value="仇恨言论" >仇恨言论</option>
				                <option value="滥用" >滥用</option>
				              </select>
				          </div>
				          <div class="form-group">
				            <label for="pwd">其他 :</label>
				            <textarea name="other" rows="5" cols="20" class="form-control" placeholder="其他 ....." ></textarea> 
				         </div>
				         <div class="modal-footer">
				          <button type="submit" name="back" class="btn btn-primary" data-dismiss="modal">背部</button>
				          <button type="submit" name="send" class="btn btn-success" data-dismiss="modal">发送</button>
				        </div>  
		            </div>
		            </form>
		            	<?php   
		          ...
		          <?php   }
                        ...
                        <?php  }else{ ?> 
                        	<script> 
                        	      swal("注意!","报告没有添加！ 您已经报告了此评论","warning");
                            </script> 
		           		<?php }  
		           	}//id c
