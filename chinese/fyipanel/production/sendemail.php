    ...
    if(userModel::isLoged_but_un_lock()){ 
      ...
      foreach($files as $file){ 
       ...
       function  emails($to,$name_user,$name_web_site,$subject,$body,$email_sender,$password_sender,$host,$port,$smtpsecure,$link){   
        $body2="<table border='0; cellspacing='0; cellpadding='0; width='80%' bgcolor='FFFFFF' style='background-color:#ffffff;'>
        <tbody>  
            <tr style='width:80%' >
              <td style='font-size: 19px;  font-family: Helvetica; line-height: 150%; text-align: left;padding:20px;' >
               $body
          </td> 
      </tr>             
        </tbody>
