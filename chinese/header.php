				...
				<div class="container">					
					<div style="background-color: #55abcd;" id="menu-list">
						<ul id="colorblack" class="nav-list">  
							...
							<li><a href="favorite_countries.php"  >最喜欢的来源</a></li>
						...
						<?php }  
						 if(!isMobile()){ ?>
							<li  class="dropdown magz-dropdown">
									 ...
									 <?php } ?>
							<li  class="font"><a target="_blank"  href="search.php" 
				 ...
				 <div id="menu-lists">
					 ...
					 <li style="background-color: red; " class="backk" >
						 <a style="  font-size: 30px; color:#fff; border-bottom: none !important; ">
                            ...
                            <li><a href="breaking_news.php?n=1">突发新闻</a></li>
                            <?php
                            ...
                            ?>
							<li><a href="category.php?id=News&n=1">新闻</a></li>
							<li><a href="category.php?id=Sports&n=1">体育</a></li>
                            <li><a href="category.php?id=Economy&n=1">经济</a></li>
                            <li><a href="category.php?id=Health&n=1">健康</a></li>
							<li><a href="category.php?id=Arts&n=1">艺术</a></li>
							<li><a href="category.php?id=Technology&n=1">科技</a></li>
							<li><a href="category.php?id=Culture&n=1">一般文化</a></li> 
							<li><a href="library.php?n=1">图书馆</a></li>
                            <li class="dropdown"><a  href="#">国别</a>
