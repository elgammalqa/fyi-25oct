        ...
        <form method="post" action="">
            ...
            <div class="row">
                <div class="col-xs-12 text-center">
                    <input type="submit"  name="Enregistrer" value=" 救 ">
                </div>
            </div>
        </form>
    </div>
...
if ($log) {
    ...
    foreach ($all_user_sources as $source) {
        $topic = 'ch-' . str_replace(' ', '__', $source['country']) . '-' . str_replace(' ', '__', $source['source']);
    ...
    foreach ($selected_sources as $src) {
        ...
        $topic = 'ch-' . str_replace(' ', '__', $country) . '-' . str_replace(' ', '__', $source);
        $fcm = new WebFCMToTopic();
