              ...
              <div class="row">
                  <div class="col-md-12">
                      <ol class="breadcrumb">
                          ...
                          <li class="active">突发新闻</li>
                      </ol>
                      <h1 class="page-title">突发新闻</h1>
                              ...
                              <div class="details  ">
                                        ...
                                        <div class="detail" style="float: left;">
                                            ...
                                            <div class="time right_of_reply">
                                                <span class=" ">
                                                    <a class="right_of_reply_news_link" href="news_reply.php?news=<?=$news['id']?>&r=2">答辩权 <img src="images/microphone.png" alt=""></a>
                                                </span>
                                            </div>
            ...
            <div class="inner">
              ...
              <div class="details  ">
                        ...
                        <div class="detail" style="float: left;">
                            ...
                            <div class="time right_of_reply">
                                <span class=" ">
                                    <a class="right_of_reply_news_link" href="news_reply.php?news=<?=$news['id']?>&r=<?=$news['rank']?>">答辩权 <img
        ...
        <div class="col-md-12 text-center  " style="padding-bottom: 30px;">
            ...
            <?php if(news_publishedModel::nbrhotnews()>0){  ?>
                <div class="col-md-4 sidebar" id="sidebar">
                    <aside>
                        <br>
                        <h1 id="ptop" class="aside-title">最新新闻</h1>
