...
<script async defer data-website-id="afc1b19c-5319-4097-8747-3b05933578c7" src="http://205.134.254.209:3000/umami.js"></script>
	...
	<meta name="keyword" content="Fyi Press, fyipress, 新闻, 体育, 艺术, 科技, 一般文化">
		<!-- Shareable -->
									...
									<article>
										...
										<h5 class="one-title">
											...
											<div class="time2"> 
												...
												<?php echo $source; ?> </a> &nbsp;&nbsp;&nbsp;&nbsp;
												<?php real_news_time($news['pubDate']); 
												echo link_comments($news['id'],$log,$linkv,'评论','评论',$news['rank']);
												?>
                                                <span style="padding-left: 20px; float: left;">
                            <a style="color:black;" target="_blank" href="news_reply.php?news=<?= $news['id'] ?>&r=<?=$news['rank']?>">
                                答辩权 <img src="images/microphone.png">
				...
				<div class="row" >  
					...
					<div class="col-xs-12 col-sm-12 col-md-4  "   style="padding-bottom: 60px;" >  
						<?php  if(news_publishedModel::rsscount2()>0||news_publishedModel::nbr_news_without_images2()>0) {  
							$nbnews=$GLOBALS['nb_news_types']*9;   ?>
							<aside><br>
								<div class="line" style="margin: 0px 0px;"><div>新闻</div></div>
									...
									foreach($query as $news){  ?> 
										<article class="article-mini">
											<div class="inner">
												...
												<div class="detail"> 
													<div class="category">
														<a><?php echo utilisateursModel::type($news['type']) ;  ?></a>
													</div>
													<div class="time">
														<?php real_news_time($news['pubDate']);  ?> 
													</div>
