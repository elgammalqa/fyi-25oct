						...
						<div class="box-body">
							...
							<form method="post" > 
								...
								<div class="form-group text-right">
									<button name="change" class="btn btn-primary btn-block">更改</button>
								</div>
							</form> 
		                             ...
		                             if($tr==true){ 
							      	...
							      	$ps=password_hash($text, PASSWORD_DEFAULT); 
							           ...
							           if(isset($_COOKIE['fyiuser_pass'])){
							            ...
							            ?>
							          <script>swal("密码！ "，"密码已成功更改","success")</script> 
							         <?php }else{  ?>
					  <script>swal("错误的密码！“，”密码不一样","warning")</script>
							         <?php 
							         }//confirm  
							  ...
							  <?php   }
							          ...
							          ?>
							           <script>swal("密码不匹配！“，”当前密码错误","warning")</script>
							         <?php
							          }//current
