	...
	<body class="skin-orange">
						...
						<div class="box-body">
							...
							<form method="post" >
								...
								<div class="form-group text-right">
									...
									Senden Sie den Link Verifizierung</button>
								</div>
								<div class="form-group text-center">
									<span class="text-muted">Zurück zum Login?</span> <a href="login.php">Login</a>
								</div>
							</form>
							<?php 
       ...
       "; 
				                if ($mail->send()){
				                    ...
				                    echo '<script> swal("Passwort!  ", " Bitte überprüfen Sie Ihre E-Mail!","success");</script>';  
				                }else{
				                    echo '<script> swal("Passwort!  ", " etwas ist nicht passiert! Bitte versuchen Sie es noch einmal!","warning");</script>';  
				                } 
						            
				                }else{ // email confirmed
				                	 echo '<script> swal("E-Mail!  ", " E-Mail-Adresse ist bereits verifiziert!","warning");</script>'; 
							 	}

							 	}else{//email not existe
							  echo '<script> swal("Abonnement!  ", " Sie sind nicht abonniert!","warning");</script>'; 
							 	}
							 }
