	...
	<body class="skin-orange">
					...
					<div class="box box-border">
						<div class="box-body">
							...
							<form method="post" >
								...
								<div class="form-group">
									<label class="fw">Kennwort</label>
									<input placeholder="Passwort muss mindestens sechs Zeichen sein (ein Zeichen oder ein Buchstabe) und eine Nummer " required="required" type="password" name="password" class="form-control">
								</div>
								<div class="form-group">
									<label class="fw">Passwort bestätigen</label>
									<input placeholder="Passwort muss mindestens sechs Zeichen sein (ein Zeichen oder ein Buchstabe) und eine Nummer " required="required" type="password" name="confirm_password" class="form-control">
								</div> 
								<div class="form-group text-right">
									<button name="register" class="btn btn-primary btn-block">Registrieren</button>
								</div>
								...
								<div class="form-group text-center">
									<span class="text-muted">Bereits ein Konto?</span> <a href="login.php">Login</a>
								</div>
							</form> 
							<?php if(isset($_POST['register'])){  
							     ...
							     <?php
		                            ...
		                            if ($NumbresOfCaracteres<6) {
		                              $msgg='Passwort muss mindestens sechs Zeichen sein (ein Zeichen oder ein Buchstabe) und eine Nummer';
		                            }else{
		                            if ($CountOfNumbers>=1) { 
		                            if ($NumbresOfCaracteres-$CountOfNumbers<=0)  {   $msgg='Passwort muss mindestens sechs Zeichen sein (ein Zeichen oder ein Buchstabe) und eine Nummer';
		                             }
		                             }else {
		                                $msgg='Passwort muss mindestens sechs Zeichen sein (ein Zeichen oder ein Buchstabe) und eine Nummer';
		                             }
        ...
        <tbody> 
            ...
            <tr> 
                ...
                Hallo $name, <br> <br> Willkommen zu FYI Press .  <br><br>
			        So aktivieren Sie Ihr Konto und bestätigen Ihre E-Mail-Adresse,<br>
                    Bitte klicken Sie auf den Link unten : <br> <br> <span style='padding-left: 100px;' ></span>
            ...
            <tr>  
            	<td>
                    ...
                    <span style='font-size: 19px; padding: 20px;  font-family: Helvetica; line-height: 150%; text-align: left; color: #505050;' >   Copyright © FYI Press, Alle Rechte vorbehalten.  </span> 
                </td>
            </tr>
				                ...
				                if ($mail->send()){ 
				                    ...
				                    echo '<script> swal("Passwort!  ", " Sie wurden registriert! Bitte überprüfen Sie Ihre E-Mail!","success");</script>'; 
				                } else{ 
				                    echo '<script> swal("Passwort!  ", " etwas ist nicht passiert! Bitte versuchen Sie es noch einmal!","warning");</script>';
				                }

						               }else{  ?>
						          <script>
						          	swal("Falsches Passwort!  ", " Passwörter sind nicht gleich","warning")
						          </script>
				      <?php } //
			     }else { // not string   ?>
						          <script>
						          	swal("Passwort !","<?php echo $msgg; ?>","warning")
						          </script>
		   <?php }  
						               }
						           }  ?> 
