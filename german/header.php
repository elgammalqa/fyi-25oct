...
<script async defer data-website-id="afc1b19c-5319-4097-8747-3b05933578c7" src="http://205.134.254.209:3000/umami.js"></script>
    ...
    <style type="text/css">
        ...
        @media only screen and (min-width: 991px) {
            ...
            #menu-lists ul.nav-list.plm > li:first-child {
                color: red;
                width: 150px;
            }
                    ...
                    <ul id="colorblack" class="nav-list">
                        <?php if (isMobile()) { ?>
                            <li style="background-color: red; " class="backk"><a
                                        style="  font-size: 30px; color:#fff; border-bottom: none !important; ">Zurück <i style="text-align: left; font-size: 30px;"
                        ...
                        <li><a href="favorite_countries.php">Lieblingsquellen</a></li>
                        <?php if ($log == false) { ?>
                                ...
                                <ul id="colorblack2" class="dropdown-menu">
                                    <li>
                                        <a href="resetpass.php">
                                            <i class="icon ion-key"> </i>Passwort ändern
                                        </a>
                                    </li>
                                    <li class="divider"></li>
                        ...
                        if (!isMobile()) { ?>
                            <li class="dropdown magz-dropdown">
                                ...
                                <a style="  padding-left:50px;">Sprachen <i class="ion-ios-arrow-right"></i></a>
                                <ul id="colorblack2" class="dropdown-menu">
                                    ...
                                    <li><a class="pl" href="index.php">Deutsche</a></li>
                    ...
                    <ul class="nav-list plm">
                        <?php if (isMobile()) { ?>
                            <li style="background-color: red; " class="backk">
                                <a style="  font-size: 30px; color:#fff; border-bottom: none !important; ">Zurück <i style="text-align: left; font-size: 30px;"
                                                                                                                     class="ion-ios-arrow-forward"></i></a></li>
                        <?php } ?>
                        <li><a href="breaking_news.php?n=1">Aktuelle Nachrichten</a></li>
                        <?php
                        ...
                        ?>
                        <li><a href="category.php?id=News&n=1">Nachrichten</a></li>
                        <li><a href="category.php?id=Sports&n=1">Sport</a></li>
                        <li><a href="category.php?id=Economy&n=1">Wirtschaft</a></li>
                        <li><a href="category.php?id=Health&n=1">Gesundheit</a></li>
                        <li><a href="category.php?id=Arts&n=1">Kunst</a></li>
                        <li><a href="category.php?id=Technology&n=1">Technologie</a></li>
                        <li><a href="category.php?id=Culture&n=1">Kultur</a></li>
                        <li><a href="library.php?n=1">Bibliothek</a></li>
                        <li class="dropdown"><a  href="#">Länder</a>
