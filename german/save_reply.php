                        ...
                        if ($log && $_SERVER['REQUEST_METHOD'] == 'POST') {
                                ...
                                if (!empty($_FILES['file-3']['name'])) {
                                    ...
                                    if (!in_array($file_extension, $allowed_image_extension)) {
                                        echo 'Zulässige Erweiterungen jpg,jpeg and png';
                                        exit;
                                    } else {
                                        $maxsize = utilisateursModel::info("maxsizecomments");
                                        if (ceil($_FILES['file-3']['size'] / 1048576) > $maxsize) {
                                            echo 'Bitte laden Sie Bilder in kleiner Größe hoch';
                                            exit;
                                        } else {
                                            ...
                                            if (move_uploaded_file($_FILES["file-3"]["tmp_name"], $target_file)) {
                                                ...
                                                echo 'Fehler beim Hochladen! Bitte versuche es erneut';
                                            }
                                    ...
                                    ?>
                                        <div class="row" style="margin-top: 80px;">
                                            <div class="col-xs-12 text-center">
                                                <h2>Erfolg</h2>
                                                <h3>Die Antwort wird nach Überprüfung veröffentlicht</h3>
                                                <h3>Freundliche Grüße</h3>
                                                <h3>FYIPress-Team</h3>
                                            </div>
                                        </div>
                                    <?php
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 text-center">
                                                <h2>Error</h2>
                                                <h3>Bitte versuche es erneut</h3>
                                            </div>
                                        </div>
                                    <?php
                                    }
