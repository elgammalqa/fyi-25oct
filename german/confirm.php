		...
		<section class="category">
					<div class="container">
						...
						if (utilisateursModel:: email_non_confirmed_existe($email,$token)!=null) {
							  ...
							  echo '<br><br><br><br> <span id="pl1" style="font-size: 30px; " >  Ihre E-Mail wurde überprüft!</span> <br><br> <span id="pl2"style="  font-size: 30px; "> Sie können sich jetzt einloggen! Auf <a href="login.php"> here </a> Anmeldung</span>';
								} else{
									redirect();
								}
							}
