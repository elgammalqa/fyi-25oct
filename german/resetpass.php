						...
						<div class="box-body">
							...
							<form method="post" > 
								...
								<div class="form-group text-right">
									<button name="change" class="btn btn-primary btn-block">Ändern</button>
								</div>
							</form> 
		                             ...
		                             if($tr==true){ 
							      	...
							      	$ps=password_hash($text, PASSWORD_DEFAULT); 
							           ...
							           if(isset($_COOKIE['fyiuser_pass'])){
							            ...
							            ?>
							          <script>swal("Passwort!  ", " Passwort wurde erfolgreich geändert","success")</script> 
							         <?php }else{  ?>
					  <script>swal("Falsches Passwort!  ", " Passwörter sind nicht gleich","warning")</script>
							         <?php 
							         }//confirm  
							  ...
							  <?php   }
							          ...
							          ?>
							           <script>swal("Passwort passt nicht!  ", " Das aktuelle Passwort ist falsch","warning")</script>
							         <?php
							          }//current
