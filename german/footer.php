<?php   
        ...
        function get_ad_id($link,$t){  
          ...
          <?php  }  ?>  
<head>
<script async defer data-website-id="afc1b19c-5319-4097-8747-3b05933578c7" src="http://205.134.254.209:3000/umami.js"></script><link rel="stylesheet" type="text/css" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css"> 
	<style type="text/css">  
section { 
    padding: 60px 0;  
}
...
div.fixeddiv {
      background-image: url("../logos/german.png"); 
      position: fixed;
      top: 300px;
      right: 5px;  
      width: 56px;
		...
		<div class="container">
			<div class="row text-center text-xs-center text-sm-left text-md-left" style="padding-bottom: 30px;"  >
				<div class="col-xs-12 col-sm-12 col-md-12">
					<p class="xfooter">  Wer sind wir </p> 
					<p class="xfooter2">
			...
			<div class="row"  >
				<div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-5" >
					<p class="xfooter2"> Sprechen Sie uns an </p> 
					<ul class="list-unstyled list-inline social text-center footerCenter" style="background-color: white" > 
