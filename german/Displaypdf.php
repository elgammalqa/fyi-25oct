...
<script async defer data-website-id="afc1b19c-5319-4097-8747-3b05933578c7" src="https://www.fyipress.net/umami.js"></script>
	...
	<body class="skin-orange">
		...
		<div class="container" id="help">
			<h4 style="color: #3da0ca;">1- Öffnen Sie Ihre Downloadmanger und gehen Sie zu Optionen</h4>
			<br>
			<img src="images/1.jpg">
			<hr>
			<h4 style="color: #3da0ca;">2- Aus Optionen wählen Sie Dateitypen</h4>
			<br>
			<img src="images/2.jpg">
			<hr>
			<h4 style="color: #3da0ca;">3- Aus Dateitypen löschen (PDF) Erweiterung Wie im Bild und drücken Sie OK</h4> 
			<br>
