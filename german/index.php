                          ...
                          // ads  
									if (adsModel::nbr_ads2()>0) {
										...
										<div class=" time2"> 
											...
											echo ads_link_comments($news['id'],$log,$linkv,'Kommentar','Kommentare'); 
											?>
										</div>
                            ...
                            <a style="color:black;" target="_blank" href="news_reply.php?news=<?= $news['id'] ?>&r=<?=$news['rank']?>">
                                Recht auf Antwort <img src="images/microphone.png">
                            </a>
                                        </span>
											</div>
										</article>
								...
								if($nbrnewstodisplay>0){ 
									...
									foreach($req as $news){  
										...
										<article>
											...
											<?php	}else  if ($type=="audio"||$type=="video") { ?>  <video width="100%" class="video_height" controls 
											...
											<div class="time2">
												...
												<?php echo $source; ?> </a> &nbsp;&nbsp;&nbsp;&nbsp;
												<?php real_news_time($news['pubDate']); 
												echo link_comments($news['id'],$log,$linkv,'Kommentar','Kommentare',$news['rank']);
												?>
                                                <span style="padding-left: 20px; float: left; margin-right: 10px;">
                            <a style="color:black;" target="_blank" href="news_reply.php?news=<?= $news['id'] ?>&r=<?=$news['rank']?>">
                                Recht auf Antwort <img src="images/microphone.png">
				...
				<div class="row" > 
					...
					<div class="col-xs-12 col-sm-12 col-md-4"   style="padding-bottom: 60px;" >  
						<?php if(news_publishedModel::rsscount2()>0||news_publishedModel::nbr_news_without_images2()>0) { 
							...
							<aside><br>
								<div class="line" style="margin: 0px 0px;"><div> Nachrichten </div></div>
							...
							<?php if(news_publishedModel::pdfcount()>0){ ?>
								<h1 class="title-col">
									Bibliothek
									<div class="carousel-nav" id="hot-news-nav">
										<div class="prev">
