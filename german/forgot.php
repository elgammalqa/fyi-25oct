						...
						<div class="box-body">
							...
							<form method="post" >
								...
								<div class="form-group text-right">
									<button class="btn btn-primary btn-block" name="reset" >Passwort zurücksetzen</button>
								</div>
        ...
        <tbody>
          <tr>
            ...
            <tr>
              ...
              Um Ihr Passwort zurückzusetzen ,<br>
              ...
              <td>
                    ...
                    <span style='font-size: 19px; padding: 20px;  font-family: Helvetica; line-height: 150%; text-align: left; color: #505050;' > Copyright © FYI Press, Alle Rechte vorbehalten.  </span> 
				                ...
				                if ($mail->send()) {
				                    ...
				                    echo '<script> swal("Passwort!  ", " Bitte überprüfen Sie Ihren E-Mail-Posteingang!","success");</script>'; 
				               } else{
