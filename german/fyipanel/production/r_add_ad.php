...
include '../models/ads.model.php'; 
  if(userModel::islogged("Reporter")==true){ 
    if(userModel::isLoged_but_un_lock()){
      ...
      if (count($_COOKIE)>0)  setcookie('fyiplien','r_add_ad.php',time()+2592000,"/");
       else   $_SESSION['auth']['lien']="r_add_ad.php";   
              ...
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <ul class="nav navbar-right panel_toolbox">
                    <li><a style="color: green; font-weight: bold;" target="_blank" 
                      href="r_thumbnail_content_add.php"> 
                      Add preview image to video</a>
                    </li> 
                    <li><a></a></li>
                      <li><a style="color: red; font-weight: bold;" target="_blank" href="linkreporter_ad.php">
                      Add media </a></li>
                ...
                <form method="POST" id="demo-form2" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left"> 
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input required="required" type="file"  accept="video/*|image/*" id="first-name" name="image"  class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
