...
'$id'");
                        ...
                        if(isset($_POST['handle_reply'])){
                            ...
                            switch ($publish_status){
                                case '1':
                                    $published = true;
                                    $mail_feedback_message = 'Das Recht auf Gegendarstellung wurde veröffentlicht';
                                    break;
                                case '0':
                                    $mail_feedback_message = 'Das Recht auf Gegendarstellung wurde abgelehnt';
                            }
                            ...
                            if($q->execute()){
                                ...
                                $mail->Subject="FYIPress - Überprüfung des Rückantwortrechts";
                                $name = $row['name'];
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                            <td style='font-size: 19px; padding: 20px;  font-family: Helvetica; line-height: 150%; text-align: right;' >
                                               ...
                                               <br> <br>
                                                Zu FYIPress      <br><br>
                                               Ihr Antwortrecht wurde überprüft <br>
                                               ".$mail_feedback_message." 
                                                <br>
                                                ".$feedback." <br> 
                                        ...
                                        <tr>  
                                            <td style='text-align: right; padding: 20px;' >
                                                ...
                                                Alle Rechte vorbehalten FYIPress       
                                                </span> 
                                            </td>
                                        </tr>           
                                    </tbody> 
