                ...
                <div class="row">
                    <div class="col-md-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><?=$country?> Nachrichten</li>
                        </ol>
                        <h1 class="page-title"><?=ucwords($country)?> Nachrichten</h1>
                    </div>
                </div>
                <div class="line"></div>
                <div class="row">
                                        ...
                                        <div class="detail" style="float: left;">
                                            ...
                                            <div class="time ">
                                                ...
                                                <div class="time right_of_reply">
                                                                    <span class=" ">
                                                                        <a href="news_reply.php?news=<?=$news['id']?>&r=<?=$news['rank']?>">Recht auf Antwort<img src="images/microphone.png" alt=""></a>
                                                                    </span>
                                                </div>
