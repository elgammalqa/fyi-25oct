  ...
  <body>  
    <div class="content">
        <div class="container stats"> 
            <h1>Wählen Sie die Quelle : </h1> <hr>
        </div>
            ...
            <div class="row"> 
              ...
              ?>
                <div class="col-xs-12 col-md-5 col-md-push-4 card_container">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="card card-stats">
                                ...
                                <a href="favorite_types.php?country=<?php echo $pays; ?>&source=<?php echo $source; ?>" class="fav_source_link">
                                    ...
                                    <span class="followers_count">Followers  <?= number_format_unchanged_precision($id_count) ?> </span>
                                </a>
                    ...
                    <input type="submit"  name="Enregistrer" value=" Sparen ">
    ...
    <script>  
     ...
     <?php   
      }else{  echo "<script> alert('You must follow At least five sources'); </script>";    } 
