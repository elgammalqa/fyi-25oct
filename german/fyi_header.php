						...
						<ul id="colorblack" class="nav-list">  
						 <?php if(isMobile()){ ?>
							<li style="background-color: red; " class="backk" ><a 
								style="  font-size: 30px; color:#fff; border-bottom: none !important; ">Zurück <i style="text-align: left; font-size: 30px;" class="ion-ios-arrow-forward"></i></a></li> 
							 <?php }else{ ?> 
							...
							<!--
							<li><a target="_blank" href="favorite_countries.php"  >Lieblingsquellen</a></li>
							-->
							<?php if ($log==false) {  ?>
				    ...
				    <div id="menu-lists">
					 ...
					 <?php if(isMobile()){ ?>
							<li style="background-color: red; " class="backk" >
								<a style="  font-size: 30px; color:#fff; border-bottom: none !important; ">Zurück <i style="text-align: left; font-size: 30px;" class="ion-ios-arrow-forward"></i></a></li>
							 <?php } ?>   
							<li><a href="fyi_category.php?id=News&n=1">Nachrichten</a></li>
							<li><a href="fyi_category.php?id=Sports&n=1">Sport</a></li>
							<li><a href="fyi_category.php?id=Arts&n=1">Kunst</a></li>
							<li><a href="fyi_category.php?id=Technology&n=1">Technologie</a></li>
							<li><a href="fyi_category.php?id=Culture&n=1">Allgemeine Kultur</a></li> 
							<li><a href="fyi_library.php?n=1">Bibliothek</a></li>  
						</ul>
					</div>  
					  <?php if(isMobile()){ ?>
                   <div id="menu-lang">
