		      ...
		      <div class="col-md-8 text-left"> 
								<div class="row">
						          <div class="col-md-12">
						            ...
						            <h1 class="page-title">Kategorie: <?php echo  utilisateursModel::type($source); ?></h1>
						            <p class="page-subtitle">Alle Beiträge mit Kategorie anzeigen <i><?php echo utilisateursModel::type($source); ?></i></p>
							          </div>
							    </div>
							    <div class="line"></div>
							    <div class="row">
