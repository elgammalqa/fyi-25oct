			...
			<div class="container">
				<div class="row"> 
                  ...
                  <div class="col-md-8">
		            ...
		            <div style="padding-left: 50px; padding-right: 50px;" >
		            	 <div class="form-group">
				            <label for="sel1">Art des Berichts :</label>
				              <select required="required" name="typee" class="form-control" id="sel1"> 
				                <option value="Sexueller Inhalt" >Sexueller Inhalt</option>
				                <option value="Gewalttätiger Inhalt" >Gewalttätiger Inhalt</option>
				                <option value="Schlechte Worte" >Schlechte Worte</option>
				                <option value="Hassrede" >Hassrede</option>
				                <option value="Missbrauch" >Missbrauch</option>
				              </select>
				          </div>
				          <div class="form-group">
				            <label for="pwd">Andere :</label>
				            <textarea name="other" rows="5" cols="20" class="form-control" placeholder="Andere ....." ></textarea> 
				         </div>
				         <div class="modal-footer">
				          <button type="submit" name="back" class="btn btn-primary" data-dismiss="modal">Zurück</button>
				          <button type="submit" name="send" class="btn btn-success" data-dismiss="modal">Senden</button>
				        </div>  
		            </div>
		            </form>
		            	<?php   
		          ...
		          <?php   }
                        ...
                        <?php  }else{ ?> 
                        	<script> 
                        	      swal("Beachtung!","Bericht nicht hinzugefügt! Du hast diesen Kommentar bereits gemeldet","warning");
                            </script> 
		           		<?php }  
		           	}//id c
