			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						...
						<p class="lead">Die Seite, die Sie suchen, ist nicht verfügbar, bitte überprüfen Sie die URL, die Sie besuchen werden.</p>
						<div class="search-form">

							<div class="link">
								Oder <a href="index.php">Zurück in die Heimat</a>.
							</div>
						</div>
					</div>
				</div>
