...
<div class="content container">
    ...
    <div class="container stats" style="display: none"><br><h1 style="text-align: right;"  >   Länderliste</h1><hr></div>
...
if ($log) {
    ...
    foreach ($all_user_sources as $source) {
        $topic = 'ge-' . str_replace(' ', '__', $source['country']) . '-' . str_replace(' ', '__', $source['source']);
    ...
    foreach ($selected_sources as $src) {
        ...
        $topic = 'ge-' . str_replace(' ', '__', $country) . '-' . str_replace(' ', '__', $source);
        $fcm = new WebFCMToTopic();
