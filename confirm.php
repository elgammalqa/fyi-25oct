					...
					<div class="container">
					    <div class="col-md-12 col-sm-12 col-xs-12">  
						 <?php 
							...
							echo '<br><br><br><br> <span id="pl1" style="font-size: 30px; " >  Your email has been verified!</span> <br><br> <span id="pl2"style="  font-size: 30px; "> You can log in now! Click <a href="login.php"> here </a> to login</span>'; 
							} else{
							 redirect(); 
							}
							}
