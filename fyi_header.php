				...
				<div class="container">					
					<div style="background-color: #55abcd;" id="menu-list">
						...
						<?php } ?>   
							...
							<!--
							<li><a target="_blank" href="favorite_countries.php"  >Favorite Sources</a></li>
							--> 
							<?php if ($log==false) {  ?>
					  ...
					  if(!isMobile()){ ?>
							   ...
							   <?php } ?> 
							<li  class="font"  >
								<a target="_blank"  href="fyi_search.php"
				    ...
				    <div id="menu-lists">
					 ...
					 <?php if(isMobile()){ ?>
							<li style="background-color: red; " class="backk" >
							 ...
							 <?php } ?>
							<li><a href="fyi.php">Home</a></li> 
							<li><a href="fyi_category.php?id=News&n=1">News</a></li>
							<li><a href="fyi_category.php?id=Sports&n=1">Sports</a></li>
							<li><a href="fyi_category.php?id=Arts&n=1">Arts</a></li>
							<li><a href="fyi_category.php?id=Technology&n=1">Technology</a></li>
							<li><a href="fyi_category.php?id=Culture&n=1">General Culture</a></li> 
							<li><a href="fyi_library.php?n=1">Library</a></li>  
						</ul>
					</div>    
					  <?php if(isMobile()){ ?>
                   <div id="menu-lang">
